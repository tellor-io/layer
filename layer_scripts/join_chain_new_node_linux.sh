...
#./layerd start --home ~/.layer/bill --api.enable --api.swagger --panic-on-daemon-failure-enabled=false --p2p.seeds "837a0c79947fcb150c8305f992729fe90353ca1a@tellornode.com:26656"