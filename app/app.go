...
func New(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		capabilitytypes.StoreKey, icacontrollertypes.StoreKey, consensusparamtypes.StoreKey,
		// Keep group.StoreKey mounted until the next upgrade so StoreUpgrades.Deleted can purge it.
		group.StoreKey,
