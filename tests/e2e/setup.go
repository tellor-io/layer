...
func MakeGenesis(nodes []*Node, accounts []*Account) (types.GenesisDoc, error) {
	...
	appGenState := app.ModuleBasics.DefaultGenesis(encCdc.Marshaler)
	...
	appGenState[bank.ModuleName] = encCdc.Marshaler.MustMarshalJSON(bankGenesis)
	appGenState[auth.ModuleName] = encCdc.Marshaler.MustMarshalJSON(authGenesis)
	appGenState[staking.ModuleName] = encCdc.Marshaler.MustMarshalJSON(stakingGenesis)
	appGenState[slashing.ModuleName] = encCdc.Marshaler.MustMarshalJSON(slashingGenesis)

	if err := app.ModuleBasics.ValidateGenesis(encCdc.Marshaler, encCdc.TxConfig, appGenState); err != nil {
