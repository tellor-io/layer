...
replace (
	// Fix for comet.BlockInfo undefined error - downgrade cosmossdk.io/core to v0.11.3
	// Reference: Babylon solution for same issue (https://github.com/babylonlabs-io/babylon/blob/main/go.mod)
	...
	github.com/docker/docker/api => github.com/docker/docker v24.0.9+incompatible
