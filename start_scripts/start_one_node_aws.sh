...
echo "Set prometheus retetntion time to 60s"
...
#./layerd start --home ~/.layer/alice --api.enable --api.swagger --panic-on-daemon-failure-enabled=false | tee ./first_node_logs.txt