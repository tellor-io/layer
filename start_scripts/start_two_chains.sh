...
# Tip 
#  ./layerd tx oracle tip  \
#   1000000loya \
#   --from alice \
#   --chain-id layertest-4 \
#   --keyring-backend test \
...
# # Submit
# ./layerd tx oracle submit-value  \
#    \
#   --from alice \
#   --chain-id layertest-4 \
#   --keyring-backend test \
#   --home ~/.layer/alice \
...
# sepolia bridgeId
#   qdata:
#   
...
# mainnet value
#   value:
#   




# bridge deposit 1 queryData:
# 

# bridge deposit value 5 trb 0 tip comm_addr
# 


# ./layerd tx oracle submit-value \
#    \
#    \
#   --from alice \
#   --chain-id layertest-4 \
#   --keyring-backend test \
#   --home ~/.layer/alice \
...
# ./layerd query auth module-accounts | grep -A 3 -B 4 "extra_rewards_pool"

# - type: cosmos-sdk/ModuleAccount
#   value:
#     account_number: 12
#     address: tellor17wa2hwtrmfdytr4fnfueajalhr468tmu0p2h58
...
# ./layerd query bank balance tellor17wa2hwtrmfdytr4fnfueajalhr468tmu0p2h58 loya
