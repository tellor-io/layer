...
func main() {
	...
	checkpointHex := "1d312e6e91f512438aa9ba10252a080d2d075bf4cd54c224983fd409871fe6d5 "

	// ===== HARDCODED ATTESTATION DATA =====

	// hardcoded query ID for testing
	queryId := "7671084a24bcbcfe3b6fafb6597fb65a134c3cff72db66efe9e5928c2d8ae1e0"

	// malicious value (different from what was actually reported)
	maliciousValue := ""

	// timestamps and other data
	currentTime := uint64(1775142502000)
