...
// RegisterMedianValuesServiceHandlerServer registers the http handlers for service MedianValuesService to "mux".
// UnaryRPC     :call MedianValuesServiceServer directly.
...
// RegisterMedianValuesServiceHandlerFromEndpoint is same as RegisterMedianValuesServiceHandler but
...
func RegisterMedianValuesServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterMedianValuesServiceHandler(ctx, mux, conn)
}

// RegisterMedianValuesServiceHandler registers the http handlers for service MedianValuesService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterMedianValuesServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterMedianValuesServiceHandlerClient(ctx, mux, NewMedianValuesServiceClient(conn))
}

// RegisterMedianValuesServiceHandlerClient registers the http handlers for service MedianValuesService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "MedianValuesServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "MedianValuesServiceClient"
