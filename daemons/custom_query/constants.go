		...
		Endpoints: []EndpointConfig{
			{
				...
				CombinedSources: map[string]string{
					...
					"coinmarketcap_api": "rpc:coinmarketcap",
					"coinbase_api":      "rpc:coinbase",
				},
				CombinedConfig: map[string]any{
					"coingecko_api_response_path":     []string{"usd-coin", "usd"},
					"coingecko_api_params":            map[string]string{"coin_id": "usd-coin"},
					"coinmarketcap_api_response_path": []string{"data", "3408", "quote", "USD", "price"},
					"coinmarketcap_api_params":        map[string]string{"id": "3408"},
					"coinbase_api_response_path":      []string{"data", "amount"},
					"coinbase_api_params":             map[string]string{"currency_pair": "USDC-USD"},
				},
				MarketId: "VYUSD-USD",
			},
		},
