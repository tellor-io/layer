...
func RegistryKeeper(tb testing.TB) (keeper.Keeper, *mocks.AccountKeeper, *mocks.BankKeeper, sdk.Context) {
	tb.Helper()
	...
	// Initialize params
	require.NoError(tb, k.SetParams(ctx, types.DefaultParams()))
