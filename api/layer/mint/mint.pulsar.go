...
var (
	...
	fd_Minter_bond_denom          protoreflect.FieldDescriptor
	fd_Minter_initialized         protoreflect.FieldDescriptor
)

func init() {
	file_layer_mint_mint_proto_init()
	md_Minter = File_layer_mint_mint_proto.Messages().ByName("Minter")
	fd_Minter_previous_block_time = md_Minter.Fields().ByName("previous_block_time")
	fd_Minter_bond_denom = md_Minter.Fields().ByName("bond_denom")
	fd_Minter_initialized = md_Minter.Fields().ByName("initialized")
}
...
func (x *Minter) slowProtoReflect() protoreflect.Message {
	mi := &file_layer_mint_mint_proto_msgTypes[0]
...
func (x *fastReflection_Minter) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "layer.mint.Minter.previous_block_time":
		return x.PreviousBlockTime != nil
	case "layer.mint.Minter.bond_denom":
		return x.BondDenom != ""
	case "layer.mint.Minter.initialized":
		return x.Initialized != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.mint.Minter"))
		}
		panic(fmt.Errorf("message layer.mint.Minter does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Minter) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message layer.mint.Minter does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Minter) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "layer.mint.Minter.bond_denom":
		panic(fmt.Errorf("field bond_denom of message layer.mint.Minter is not mutable"))
	case "layer.mint.Minter.initialized":
		panic(fmt.Errorf("field initialized of message layer.mint.Minter is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.mint.Minter"))
		}
...
func (x *fastReflection_Minter) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in layer.mint.Minter", d.FullName()))
	}
	panic("unreachable")
}
...
type Minter struct {
	...
	PreviousBlockTime *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=previous_block_time,json=previousBlockTime,proto3" json:"previous_block_time,omitempty"`
...
func (*Minter) Descriptor() ([]byte, []int) {
	return file_layer_mint_mint_proto_rawDescGZIP(), []int{0}
}
...
var file_layer_mint_mint_proto_rawDesc = []byte{
	0x0a, 0x15, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2f, 0x6d, 0x69, 0x6e, 0x74, 0x2f, 0x6d, 0x69, 0x6e,
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x6d,
	0x69, 0x6e, 0x74, 0x1a, 0x19, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5f, 0x70, 0x72, 0x6f, 0x74,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x01, 0x0a, 0x06, 0x4d, 0x69, 0x6e, 0x74, 0x65, 0x72,
	0x12, 0x50, 0x0a, 0x13, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x5f, 0x62, 0x6c, 0x6f,
	...
	0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x6f, 0x6e, 0x64, 0x5f, 0x64, 0x65, 0x6e, 0x6f, 0x6d,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x62, 0x6f, 0x6e, 0x64, 0x44, 0x65, 0x6e, 0x6f,
	0x6d, 0x12, 0x20, 0x0a, 0x0b, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x69,
	0x7a, 0x65, 0x64, 0x42, 0x8f, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x6c, 0x61, 0x79, 0x65,
	0x72, 0x2e, 0x6d, 0x69, 0x6e, 0x74, 0x42, 0x09, 0x4d, 0x69, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74,
	...
	0x61, 0x70, 0x69, 0x2f, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2f, 0x6d, 0x69, 0x6e, 0x74, 0xa2, 0x02,
	0x03, 0x4c, 0x4d, 0x58, 0xaa, 0x02, 0x0a, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x4d, 0x69, 0x6e,
	0x74, 0xca, 0x02, 0x0a, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x5c, 0x4d, 0x69, 0x6e, 0x74, 0xe2, 0x02,
	0x16, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x5c, 0x4d, 0x69, 0x6e, 0x74, 0x5c, 0x47, 0x50, 0x42, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0b, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x3a,
	0x3a, 0x4d, 0x69, 0x6e, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_layer_mint_mint_proto_rawDescOnce sync.Once
	file_layer_mint_mint_proto_rawDescData = file_layer_mint_mint_proto_rawDesc
)

func file_layer_mint_mint_proto_rawDescGZIP() []byte {
	file_layer_mint_mint_proto_rawDescOnce.Do(func() {
		file_layer_mint_mint_proto_rawDescData = protoimpl.X.CompressGZIP(file_layer_mint_mint_proto_rawDescData)
	})
	return file_layer_mint_mint_proto_rawDescData
}

var file_layer_mint_mint_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_layer_mint_mint_proto_goTypes = []interface{}{
	(*Minter)(nil),                // 0: layer.mint.Minter
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_layer_mint_mint_proto_depIdxs = []int32{
	1, // 0: layer.mint.Minter.previous_block_time:type_name -> google.protobuf.Timestamp
...
func init() { file_layer_mint_mint_proto_init() }
func file_layer_mint_mint_proto_init() {
	if File_layer_mint_mint_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_layer_mint_mint_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Minter); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_layer_mint_mint_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_layer_mint_mint_proto_goTypes,
		DependencyIndexes: file_layer_mint_mint_proto_depIdxs,
		MessageInfos:      file_layer_mint_mint_proto_msgTypes,
	}.Build()
	File_layer_mint_mint_proto = out.File
	file_layer_mint_mint_proto_rawDesc = nil
	file_layer_mint_mint_proto_goTypes = nil
	file_layer_mint_mint_proto_depIdxs = nil
}
