...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_layer_mint_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.BondDenom != "" {
		...
		if !f(fd_GenesisState_bond_denom, value) {
			return
		}
	}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message layer.mint.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message layer.mint.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in layer.mint.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_layer_mint_genesis_proto_rawDescGZIP(), []int{0}
}
...
var file_layer_mint_genesis_proto_rawDesc = []byte{
	...
	0x4d, 0x69, 0x6e, 0x74, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x42, 0x84, 0x01, 0x0a, 0x0e, 0x63,
	...
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x2f, 0x6d, 0x69, 0x6e, 0x74, 0xa2, 0x02, 0x03, 0x4c, 0x4d, 0x58,
	0xaa, 0x02, 0x0a, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x4d, 0x69, 0x6e, 0x74, 0xca, 0x02, 0x0a,
	0x4c, 0x61, 0x79, 0x65, 0x72, 0x5c, 0x4d, 0x69, 0x6e, 0x74, 0xe2, 0x02, 0x16, 0x4c, 0x61, 0x79,
	0x65, 0x72, 0x5c, 0x4d, 0x69, 0x6e, 0x74, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0xea, 0x02, 0x0b, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x3a, 0x3a, 0x4d, 0x69, 0x6e,
	0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_layer_mint_genesis_proto_rawDescOnce sync.Once
	file_layer_mint_genesis_proto_rawDescData = file_layer_mint_genesis_proto_rawDesc
)

func file_layer_mint_genesis_proto_rawDescGZIP() []byte {
	file_layer_mint_genesis_proto_rawDescOnce.Do(func() {
		file_layer_mint_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_layer_mint_genesis_proto_rawDescData)
	})
	return file_layer_mint_genesis_proto_rawDescData
}
...
func file_layer_mint_genesis_proto_init() {
	if File_layer_mint_genesis_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_layer_mint_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_layer_mint_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_layer_mint_genesis_proto_goTypes,
		DependencyIndexes: file_layer_mint_genesis_proto_depIdxs,
		MessageInfos:      file_layer_mint_genesis_proto_msgTypes,
	}.Build()
	File_layer_mint_genesis_proto = out.File
	file_layer_mint_genesis_proto_rawDesc = nil
	file_layer_mint_genesis_proto_goTypes = nil
	file_layer_mint_genesis_proto_depIdxs = nil
}
