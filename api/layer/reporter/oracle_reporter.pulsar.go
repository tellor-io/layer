...
var (
	md_BigUint       protoreflect.MessageDescriptor
	fd_BigUint_value protoreflect.FieldDescriptor
)

func init() {
	file_layer_reporter_oracle_reporter_proto_init()
	md_BigUint = File_layer_reporter_oracle_reporter_proto.Messages().ByName("BigUint")
	fd_BigUint_value = md_BigUint.Fields().ByName("value")
}

var _ protoreflect.Message = (*fastReflection_BigUint)(nil)

type fastReflection_BigUint BigUint

func (x *BigUint) ProtoReflect() protoreflect.Message {
	return (*fastReflection_BigUint)(x)
}

func (x *BigUint) slowProtoReflect() protoreflect.Message {
	mi := &file_layer_reporter_oracle_reporter_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_BigUint_messageType fastReflection_BigUint_messageType
var _ protoreflect.MessageType = fastReflection_BigUint_messageType{}

type fastReflection_BigUint_messageType struct{}

func (x fastReflection_BigUint_messageType) Zero() protoreflect.Message {
	return (*fastReflection_BigUint)(nil)
}
func (x fastReflection_BigUint_messageType) New() protoreflect.Message {
	return new(fastReflection_BigUint)
}
func (x fastReflection_BigUint_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_BigUint
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_BigUint) Descriptor() protoreflect.MessageDescriptor {
	return md_BigUint
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_BigUint) Type() protoreflect.MessageType {
	return _fastReflection_BigUint_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_BigUint) New() protoreflect.Message {
	return new(fastReflection_BigUint)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_BigUint) Interface() protoreflect.ProtoMessage {
	return (*BigUint)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_BigUint) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Value != "" {
		value := protoreflect.ValueOfString(x.Value)
		if !f(fd_BigUint_value, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_BigUint) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "layer.reporter.BigUint.value":
		return x.Value != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.reporter.BigUint"))
		}
		panic(fmt.Errorf("message layer.reporter.BigUint does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BigUint) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "layer.reporter.BigUint.value":
		x.Value = ""
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_BigUint) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "layer.reporter.BigUint.value":
		value := x.Value
		return protoreflect.ValueOfString(value)
	default:
		...
		panic(fmt.Errorf("message layer.reporter.BigUint does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BigUint) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "layer.reporter.BigUint.value":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BigUint) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.reporter.BigUint.value":
		panic(fmt.Errorf("field value of message layer.reporter.BigUint is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.reporter.BigUint"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_BigUint) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.reporter.BigUint.value":
		return protoreflect.ValueOfString("")
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_BigUint) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in layer.reporter.BigUint", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_BigUint) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BigUint) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_BigUint) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_BigUint) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*BigUint)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: BigUint: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: BigUint: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 2:
				if wireType != 2 {
...
func (*BigUint) Descriptor() ([]byte, []int) {
	return file_layer_reporter_oracle_reporter_proto_rawDescGZIP(), []int{1}
}

func (x *BigUint) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_layer_reporter_oracle_reporter_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0xb1, 0x01, 0x0a, 0x12, 0x63, 0x6f,
...
var file_layer_reporter_oracle_reporter_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_layer_reporter_oracle_reporter_proto_goTypes = []interface{}{
	(*OracleReporter)(nil),        // 0: layer.reporter.OracleReporter
	(*BigUint)(nil),               // 1: layer.reporter.BigUint
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_layer_reporter_oracle_reporter_proto_depIdxs = []int32{
	2, // 0: layer.reporter.OracleReporter.jailed_until:type_name -> google.protobuf.Timestamp
...
func file_layer_reporter_oracle_reporter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_layer_reporter_oracle_reporter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BigUint); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
