...
var (
	...
	fd_OracleReporter_totalTokens protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_OracleReporter_totalTokens = md_OracleReporter.Fields().ByName("totalTokens")
}
...
func (x *fastReflection_OracleReporter) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TotalTokens != uint64(0) {
		value := protoreflect.ValueOfUint64(x.TotalTokens)
		if !f(fd_OracleReporter_totalTokens, value) {
			return
		}
	}
}
...
func (x *fastReflection_OracleReporter) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "layer.reporter.OracleReporter.reporter":
		return x.Reporter != ""
	case "layer.reporter.OracleReporter.totalTokens":
		return x.TotalTokens != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_OracleReporter) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "layer.reporter.OracleReporter.totalTokens":
		panic(fmt.Errorf("field totalTokens of message layer.reporter.OracleReporter is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.reporter.OracleReporter"))
		}
...
func (x *fastReflection_OracleReporter) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.TotalTokens != 0 {
			n += 1 + runtime.Sov(uint64(x.TotalTokens))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.TotalTokens != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.TotalTokens))
			i--
			dAtA[i] = 0x10
		}
		if len(x.Reporter) > 0 {
		...
		for iNdEx < l {
			...
			case 2:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.TotalTokens |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *OracleReporter) GetTotalTokens() uint64 {
	if x != nil {
...
var file_layer_reporter_oracle_reporter_proto_rawDesc = []byte{
	...
	,
