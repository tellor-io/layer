...
var file_layer_reporter_query_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x65, 0x72, 0x32, 0xc8, 0x03, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x7b,
...
var file_layer_reporter_query_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_layer_reporter_query_proto_goTypes = []interface{}{
	...
	(*OracleReporter)(nil),                // 9: layer.reporter.OracleReporter
	(*v1beta1.PageResponse)(nil),          // 10: cosmos.base.query.v1beta1.PageResponse
}
var file_layer_reporter_query_proto_depIdxs = []int32{
	7,  // 0: layer.reporter.QueryParamsResponse.params:type_name -> layer.reporter.Params
	8,  // 1: layer.reporter.QueryReportersRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	9,  // 2: layer.reporter.reporter.metadata:type_name -> layer.reporter.OracleReporter
	3,  // 3: layer.reporter.QueryReportersResponse.reporters:type_name -> layer.reporter.reporter
	10, // 4: layer.reporter.QueryReportersResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	...
	1,  // 8: layer.reporter.Query.Params:output_type -> layer.reporter.QueryParamsResponse
	4,  // 9: layer.reporter.Query.Reporters:output_type -> layer.reporter.QueryReportersResponse
	6,  // 10: layer.reporter.Query.SelectorReporter:output_type -> layer.reporter.QuerySelectorReporterResponse
