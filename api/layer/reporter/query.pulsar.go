...
var file_layer_reporter_query_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x61, 0x63, 0x65, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x32, 0xe0,
	0x09, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x7b, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61,
...
var file_layer_reporter_query_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_layer_reporter_query_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                                // 15: layer.reporter.Params
...
var file_layer_reporter_query_proto_depIdxs = []int32{
	15, // 0: layer.reporter.QueryParamsResponse.params:type_name -> layer.reporter.Params
	16, // 1: layer.reporter.QueryReportersRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	17, // 2: layer.reporter.reporter.metadata:type_name -> layer.reporter.OracleReporter
	3,  // 3: layer.reporter.QueryReportersResponse.reporters:type_name -> layer.reporter.reporter
	18, // 4: layer.reporter.QueryReportersResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	...
	4,  // 13: layer.reporter.Query.Reporters:output_type -> layer.reporter.QueryReportersResponse
	6,  // 14: layer.reporter.Query.SelectorReporter:output_type -> layer.reporter.QuerySelectorReporterResponse
	8,  // 15: layer.reporter.Query.AllowedAmount:output_type -> layer.reporter.QueryAllowedAmountResponse
	10, // 16: layer.reporter.Query.AllowedAmountExpiration:output_type -> layer.reporter.QueryAllowedAmountExpirationResponse
	12, // 17: layer.reporter.Query.NumOfSelectorsByReporter:output_type -> layer.reporter.QueryNumOfSelectorsByReporterResponse
	14, // 18: layer.reporter.Query.SpaceAvailableByReporter:output_type -> layer.reporter.QuerySpaceAvailableByReporterResponse
