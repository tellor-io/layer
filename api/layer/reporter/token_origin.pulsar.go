...
func (x *fastReflection_TokenOriginInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.DelegatorAddress) != 0 {
		value := protoreflect.ValueOfBytes(x.DelegatorAddress)
...
func (x *fastReflection_TokenOriginInfo) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "layer.reporter.TokenOriginInfo.delegator_address":
		x.DelegatorAddress = value.Bytes()
	case "layer.reporter.TokenOriginInfo.validator_address":
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				...
				x.DelegatorAddress = append(x.DelegatorAddress[:0], dAtA[iNdEx:postIndex]...)
				if x.DelegatorAddress == nil {
					x.DelegatorAddress = []byte{}
				}
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
...
func (x *TokenOriginInfo) GetValidatorAddress() []byte {
	if x != nil {
