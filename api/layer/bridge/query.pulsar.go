...
var file_layer_bridge_query_proto_rawDesc = []byte{
	...
	0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x74, 0x32, 0xa0, 0x02, 0x0a,
	...
	0x5f, 0x65, 0x76, 0x6d, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x42,
...
var file_layer_bridge_query_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_layer_bridge_query_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                        // 6: layer.bridge.Params
}
var file_layer_bridge_query_proto_depIdxs = []int32{
	6, // 0: layer.bridge.QueryParamsResponse.params:type_name -> layer.bridge.Params
	...
	0, // 3: layer.bridge.Query.Params:input_type -> layer.bridge.QueryParamsRequest
	2, // 4: layer.bridge.Query.GetEvmValidators:input_type -> layer.bridge.QueryGetEvmValidatorsRequest
	1, // 5: layer.bridge.Query.Params:output_type -> layer.bridge.QueryParamsResponse
	3, // 6: layer.bridge.Query.GetEvmValidators:output_type -> layer.bridge.QueryGetEvmValidatorsResponse
