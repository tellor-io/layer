...
func (x *DisputeParams) GetReport() *MicroReport {
	if x != nil {
		return x.Report
	}
	return nil
...
var file_layer_dispute_dispute_params_proto_rawDesc = []byte{
	...
	0x22, 0x7f, 0x0a, 0x0d, 0x44, 0x69, 0x73, 0x70, 0x75, 0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d,
	0x73, 0x12, 0x32, 0x0a, 0x06, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x79, 0x42, 0x9c, 0x01, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e,
...
var file_layer_dispute_dispute_params_proto_goTypes = []interface{}{
	...
	(*MicroReport)(nil),   // 1: layer.dispute.MicroReport
	(DisputeCategory)(0),  // 2: layer.dispute.DisputeCategory
}
var file_layer_dispute_dispute_params_proto_depIdxs = []int32{
	1, // 0: layer.dispute.DisputeParams.report:type_name -> layer.dispute.MicroReport
