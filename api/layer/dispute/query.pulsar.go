...
var file_layer_dispute_query_proto_rawDesc = []byte{
	...
	0x04, 0x52, 0x09, 0x64, 0x69, 0x73, 0x70, 0x75, 0x74, 0x65, 0x49, 0x64, 0x22, 0xf4, 0x01, 0x0a,
	...
	,
	...
	0x65, 0x2f, 0x64, 0x69, 0x73, 0x70, 0x75, 0x74, 0x65, 0x73, 0x12, 0x91, 0x01, 0x0a, 0x0c, 0x4f,
...
var file_layer_dispute_query_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_layer_dispute_query_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                     // 13: layer.dispute.Params
	(*v1beta1.PageRequest)(nil),        // 14: cosmos.base.query.v1beta1.PageRequest
	(*Dispute)(nil),                    // 15: layer.dispute.Dispute
	(*v1beta1.PageResponse)(nil),       // 16: cosmos.base.query.v1beta1.PageResponse
	(*OpenDisputes)(nil),               // 17: layer.dispute.OpenDisputes
	(*Voter)(nil),                      // 18: layer.dispute.Voter
	(*GroupTally)(nil),                 // 19: layer.dispute.GroupTally
	(*VoteCounts)(nil),                 // 20: layer.dispute.VoteCounts
}
var file_layer_dispute_query_proto_depIdxs = []int32{
	13, // 0: layer.dispute.QueryParamsResponse.params:type_name -> layer.dispute.Params
	14, // 1: layer.dispute.QueryDisputesRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	15, // 2: layer.dispute.Disputes.metadata:type_name -> layer.dispute.Dispute
	16, // 3: layer.dispute.QueryDisputesResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	3,  // 4: layer.dispute.QueryDisputesResponse.disputes:type_name -> layer.dispute.Disputes
	17, // 5: layer.dispute.QueryOpenDisputesResponse.openDisputes:type_name -> layer.dispute.OpenDisputes
	18, // 6: layer.dispute.QueryTeamVoteResponse.team_vote:type_name -> layer.dispute.Voter
	19, // 7: layer.dispute.QueryDisputesTallyResponse.users:type_name -> layer.dispute.GroupTally
	19, // 8: layer.dispute.QueryDisputesTallyResponse.reporters:type_name -> layer.dispute.GroupTally
	19, // 9: layer.dispute.QueryDisputesTallyResponse.tokenholders:type_name -> layer.dispute.GroupTally
	20, // 10: layer.dispute.QueryDisputesTallyResponse.team:type_name -> layer.dispute.VoteCounts
	0,  // 11: layer.dispute.Query.Params:input_type -> layer.dispute.QueryParamsRequest
	2,  // 12: layer.dispute.Query.Disputes:input_type -> layer.dispute.QueryDisputesRequest
	5,  // 13: layer.dispute.Query.OpenDisputes:input_type -> layer.dispute.QueryOpenDisputesRequest
	7,  // 14: layer.dispute.Query.TeamVote:input_type -> layer.dispute.QueryTeamVoteRequest
	9,  // 15: layer.dispute.Query.TeamAddress:input_type -> layer.dispute.QueryTeamAddressRequest
	11, // 16: layer.dispute.Query.Tally:input_type -> layer.dispute.QueryDisputesTallyRequest
	1,  // 17: layer.dispute.Query.Params:output_type -> layer.dispute.QueryParamsResponse
	4,  // 18: layer.dispute.Query.Disputes:output_type -> layer.dispute.QueryDisputesResponse
	6,  // 19: layer.dispute.Query.OpenDisputes:output_type -> layer.dispute.QueryOpenDisputesResponse
	8,  // 20: layer.dispute.Query.TeamVote:output_type -> layer.dispute.QueryTeamVoteResponse
	10, // 21: layer.dispute.Query.TeamAddress:output_type -> layer.dispute.QueryTeamAddressResponse
	12, // 22: layer.dispute.Query.Tally:output_type -> layer.dispute.QueryDisputesTallyResponse
