...
func (x *fastReflection_Disputes) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "layer.dispute.Disputes.metadata":
		x.Metadata = value.Message().Interface().(*DisputeStrings)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.Disputes"))
		}
...
var (
	md_QueryDisputeFeePayersRequest            protoreflect.MessageDescriptor
	fd_QueryDisputeFeePayersRequest_dispute_id protoreflect.FieldDescriptor
)

func init() {
	file_layer_dispute_query_proto_init()
	md_QueryDisputeFeePayersRequest = File_layer_dispute_query_proto.Messages().ByName("QueryDisputeFeePayersRequest")
	fd_QueryDisputeFeePayersRequest_dispute_id = md_QueryDisputeFeePayersRequest.Fields().ByName("dispute_id")
}

var _ protoreflect.Message = (*fastReflection_QueryDisputeFeePayersRequest)(nil)

type fastReflection_QueryDisputeFeePayersRequest QueryDisputeFeePayersRequest

func (x *QueryDisputeFeePayersRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryDisputeFeePayersRequest)(x)
}

func (x *QueryDisputeFeePayersRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_layer_dispute_query_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryDisputeFeePayersRequest_messageType fastReflection_QueryDisputeFeePayersRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryDisputeFeePayersRequest_messageType{}

type fastReflection_QueryDisputeFeePayersRequest_messageType struct{}

func (x fastReflection_QueryDisputeFeePayersRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryDisputeFeePayersRequest)(nil)
}
func (x fastReflection_QueryDisputeFeePayersRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryDisputeFeePayersRequest)
}
func (x fastReflection_QueryDisputeFeePayersRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryDisputeFeePayersRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryDisputeFeePayersRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryDisputeFeePayersRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryDisputeFeePayersRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryDisputeFeePayersRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryDisputeFeePayersRequest) New() protoreflect.Message {
	return new(fastReflection_QueryDisputeFeePayersRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryDisputeFeePayersRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryDisputeFeePayersRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryDisputeFeePayersRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.DisputeId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.DisputeId)
		if !f(fd_QueryDisputeFeePayersRequest_dispute_id, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryDisputeFeePayersRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "layer.dispute.QueryDisputeFeePayersRequest.dispute_id":
		return x.DisputeId != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryDisputeFeePayersRequest"))
		}
		panic(fmt.Errorf("message layer.dispute.QueryDisputeFeePayersRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDisputeFeePayersRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "layer.dispute.QueryDisputeFeePayersRequest.dispute_id":
		x.DisputeId = uint64(0)
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryDisputeFeePayersRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "layer.dispute.QueryDisputeFeePayersRequest.dispute_id":
		value := x.DisputeId
		return protoreflect.ValueOfUint64(value)
	default:
		...
		panic(fmt.Errorf("message layer.dispute.QueryDisputeFeePayersRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDisputeFeePayersRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "layer.dispute.QueryDisputeFeePayersRequest.dispute_id":
		x.DisputeId = value.Uint()
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDisputeFeePayersRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.QueryDisputeFeePayersRequest.dispute_id":
		panic(fmt.Errorf("field dispute_id of message layer.dispute.QueryDisputeFeePayersRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryDisputeFeePayersRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryDisputeFeePayersRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.QueryDisputeFeePayersRequest.dispute_id":
		return protoreflect.ValueOfUint64(uint64(0))
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryDisputeFeePayersRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in layer.dispute.QueryDisputeFeePayersRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryDisputeFeePayersRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDisputeFeePayersRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryDisputeFeePayersRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryDisputeFeePayersRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryDisputeFeePayersRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryDisputeFeePayersRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryDisputeFeePayersRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
var (
	md_DisputeFeePayerInfo               protoreflect.MessageDescriptor
	fd_DisputeFeePayerInfo_payer_address protoreflect.FieldDescriptor
	fd_DisputeFeePayerInfo_payer_info    protoreflect.FieldDescriptor
)

func init() {
	file_layer_dispute_query_proto_init()
	md_DisputeFeePayerInfo = File_layer_dispute_query_proto.Messages().ByName("DisputeFeePayerInfo")
	fd_DisputeFeePayerInfo_payer_address = md_DisputeFeePayerInfo.Fields().ByName("payer_address")
	fd_DisputeFeePayerInfo_payer_info = md_DisputeFeePayerInfo.Fields().ByName("payer_info")
}

var _ protoreflect.Message = (*fastReflection_DisputeFeePayerInfo)(nil)

type fastReflection_DisputeFeePayerInfo DisputeFeePayerInfo

func (x *DisputeFeePayerInfo) ProtoReflect() protoreflect.Message {
	return (*fastReflection_DisputeFeePayerInfo)(x)
}

func (x *DisputeFeePayerInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_layer_dispute_query_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_DisputeFeePayerInfo_messageType fastReflection_DisputeFeePayerInfo_messageType
var _ protoreflect.MessageType = fastReflection_DisputeFeePayerInfo_messageType{}

type fastReflection_DisputeFeePayerInfo_messageType struct{}

func (x fastReflection_DisputeFeePayerInfo_messageType) Zero() protoreflect.Message {
	return (*fastReflection_DisputeFeePayerInfo)(nil)
}
func (x fastReflection_DisputeFeePayerInfo_messageType) New() protoreflect.Message {
	return new(fastReflection_DisputeFeePayerInfo)
}
func (x fastReflection_DisputeFeePayerInfo_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_DisputeFeePayerInfo
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_DisputeFeePayerInfo) Descriptor() protoreflect.MessageDescriptor {
	return md_DisputeFeePayerInfo
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_DisputeFeePayerInfo) Type() protoreflect.MessageType {
	return _fastReflection_DisputeFeePayerInfo_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_DisputeFeePayerInfo) New() protoreflect.Message {
	return new(fastReflection_DisputeFeePayerInfo)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_DisputeFeePayerInfo) Interface() protoreflect.ProtoMessage {
	return (*DisputeFeePayerInfo)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_DisputeFeePayerInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.PayerAddress != "" {
		value := protoreflect.ValueOfString(x.PayerAddress)
		if !f(fd_DisputeFeePayerInfo_payer_address, value) {
			return
		}
	}
	if x.PayerInfo != nil {
		value := protoreflect.ValueOfMessage(x.PayerInfo.ProtoReflect())
		if !f(fd_DisputeFeePayerInfo_payer_info, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_DisputeFeePayerInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "layer.dispute.DisputeFeePayerInfo.payer_address":
		return x.PayerAddress != ""
	case "layer.dispute.DisputeFeePayerInfo.payer_info":
		return x.PayerInfo != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.DisputeFeePayerInfo"))
		}
		panic(fmt.Errorf("message layer.dispute.DisputeFeePayerInfo does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_DisputeFeePayerInfo) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "layer.dispute.DisputeFeePayerInfo.payer_address":
		x.PayerAddress = ""
	case "layer.dispute.DisputeFeePayerInfo.payer_info":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_DisputeFeePayerInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "layer.dispute.DisputeFeePayerInfo.payer_address":
	...
	default:
		...
		panic(fmt.Errorf("message layer.dispute.DisputeFeePayerInfo does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_DisputeFeePayerInfo) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "layer.dispute.DisputeFeePayerInfo.payer_address":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_DisputeFeePayerInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.DisputeFeePayerInfo.payer_info":
		if x.PayerInfo == nil {
	...
	case "layer.dispute.DisputeFeePayerInfo.payer_address":
		panic(fmt.Errorf("field payer_address of message layer.dispute.DisputeFeePayerInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.DisputeFeePayerInfo"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_DisputeFeePayerInfo) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.DisputeFeePayerInfo.payer_address":
		return protoreflect.ValueOfString("")
	case "layer.dispute.DisputeFeePayerInfo.payer_info":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_DisputeFeePayerInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in layer.dispute.DisputeFeePayerInfo", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_DisputeFeePayerInfo) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_DisputeFeePayerInfo) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_DisputeFeePayerInfo) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_DisputeFeePayerInfo) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*DisputeFeePayerInfo)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: DisputeFeePayerInfo: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: DisputeFeePayerInfo: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var _ protoreflect.List = (*_QueryDisputeFeePayersResponse_1_list)(nil)

type _QueryDisputeFeePayersResponse_1_list struct {
	list *[]*DisputeFeePayerInfo
}

func (x *_QueryDisputeFeePayersResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryDisputeFeePayersResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryDisputeFeePayersResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*DisputeFeePayerInfo)
	(*x.list)[i] = concreteValue
}

func (x *_QueryDisputeFeePayersResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*DisputeFeePayerInfo)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryDisputeFeePayersResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(DisputeFeePayerInfo)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryDisputeFeePayersResponse_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryDisputeFeePayersResponse_1_list) NewElement() protoreflect.Value {
	v := new(DisputeFeePayerInfo)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryDisputeFeePayersResponse_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryDisputeFeePayersResponse        protoreflect.MessageDescriptor
	fd_QueryDisputeFeePayersResponse_payers protoreflect.FieldDescriptor
)

func init() {
	file_layer_dispute_query_proto_init()
	md_QueryDisputeFeePayersResponse = File_layer_dispute_query_proto.Messages().ByName("QueryDisputeFeePayersResponse")
	fd_QueryDisputeFeePayersResponse_payers = md_QueryDisputeFeePayersResponse.Fields().ByName("payers")
}

var _ protoreflect.Message = (*fastReflection_QueryDisputeFeePayersResponse)(nil)

type fastReflection_QueryDisputeFeePayersResponse QueryDisputeFeePayersResponse

func (x *QueryDisputeFeePayersResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryDisputeFeePayersResponse)(x)
}

func (x *QueryDisputeFeePayersResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_layer_dispute_query_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryDisputeFeePayersResponse_messageType fastReflection_QueryDisputeFeePayersResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryDisputeFeePayersResponse_messageType{}

type fastReflection_QueryDisputeFeePayersResponse_messageType struct{}

func (x fastReflection_QueryDisputeFeePayersResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryDisputeFeePayersResponse)(nil)
}
func (x fastReflection_QueryDisputeFeePayersResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryDisputeFeePayersResponse)
}
func (x fastReflection_QueryDisputeFeePayersResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryDisputeFeePayersResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryDisputeFeePayersResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryDisputeFeePayersResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryDisputeFeePayersResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryDisputeFeePayersResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryDisputeFeePayersResponse) New() protoreflect.Message {
	return new(fastReflection_QueryDisputeFeePayersResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryDisputeFeePayersResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryDisputeFeePayersResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryDisputeFeePayersResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Payers) != 0 {
		value := protoreflect.ValueOfList(&_QueryDisputeFeePayersResponse_1_list{list: &x.Payers})
		if !f(fd_QueryDisputeFeePayersResponse_payers, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryDisputeFeePayersResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "layer.dispute.QueryDisputeFeePayersResponse.payers":
		return len(x.Payers) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryDisputeFeePayersResponse"))
		}
		panic(fmt.Errorf("message layer.dispute.QueryDisputeFeePayersResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDisputeFeePayersResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "layer.dispute.QueryDisputeFeePayersResponse.payers":
		x.Payers = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryDisputeFeePayersResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "layer.dispute.QueryDisputeFeePayersResponse.payers":
		if len(x.Payers) == 0 {
			return protoreflect.ValueOfList(&_QueryDisputeFeePayersResponse_1_list{})
		}
		listValue := &_QueryDisputeFeePayersResponse_1_list{list: &x.Payers}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryDisputeFeePayersResponse"))
		}
		panic(fmt.Errorf("message layer.dispute.QueryDisputeFeePayersResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDisputeFeePayersResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "layer.dispute.QueryDisputeFeePayersResponse.payers":
		lv := value.List()
		clv := lv.(*_QueryDisputeFeePayersResponse_1_list)
		x.Payers = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryDisputeFeePayersResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDisputeFeePayersResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.QueryDisputeFeePayersResponse.payers":
		if x.Payers == nil {
			x.Payers = []*DisputeFeePayerInfo{}
		}
		value := &_QueryDisputeFeePayersResponse_1_list{list: &x.Payers}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryDisputeFeePayersResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryDisputeFeePayersResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.QueryDisputeFeePayersResponse.payers":
		list := []*DisputeFeePayerInfo{}
		return protoreflect.ValueOfList(&_QueryDisputeFeePayersResponse_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryDisputeFeePayersResponse"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryDisputeFeePayersResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in layer.dispute.QueryDisputeFeePayersResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryDisputeFeePayersResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDisputeFeePayersResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryDisputeFeePayersResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryDisputeFeePayersResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryDisputeFeePayersResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Payers) > 0 {
			for iNdEx := len(x.Payers) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.Payers[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryDisputeFeePayersResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryDisputeFeePayersResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Payers", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.Payers = append(x.Payers, &DisputeFeePayerInfo{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.Payers[len(x.Payers)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var (
	md_QueryClaimableDisputeRewardsRequest            protoreflect.MessageDescriptor
	fd_QueryClaimableDisputeRewardsRequest_dispute_id protoreflect.FieldDescriptor
	fd_QueryClaimableDisputeRewardsRequest_address    protoreflect.FieldDescriptor
)

func init() {
	file_layer_dispute_query_proto_init()
	md_QueryClaimableDisputeRewardsRequest = File_layer_dispute_query_proto.Messages().ByName("QueryClaimableDisputeRewardsRequest")
	fd_QueryClaimableDisputeRewardsRequest_dispute_id = md_QueryClaimableDisputeRewardsRequest.Fields().ByName("dispute_id")
	fd_QueryClaimableDisputeRewardsRequest_address = md_QueryClaimableDisputeRewardsRequest.Fields().ByName("address")
}

var _ protoreflect.Message = (*fastReflection_QueryClaimableDisputeRewardsRequest)(nil)

type fastReflection_QueryClaimableDisputeRewardsRequest QueryClaimableDisputeRewardsRequest

func (x *QueryClaimableDisputeRewardsRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryClaimableDisputeRewardsRequest)(x)
}

func (x *QueryClaimableDisputeRewardsRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_layer_dispute_query_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryClaimableDisputeRewardsRequest_messageType fastReflection_QueryClaimableDisputeRewardsRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryClaimableDisputeRewardsRequest_messageType{}

type fastReflection_QueryClaimableDisputeRewardsRequest_messageType struct{}

func (x fastReflection_QueryClaimableDisputeRewardsRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryClaimableDisputeRewardsRequest)(nil)
}
func (x fastReflection_QueryClaimableDisputeRewardsRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryClaimableDisputeRewardsRequest)
}
func (x fastReflection_QueryClaimableDisputeRewardsRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryClaimableDisputeRewardsRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryClaimableDisputeRewardsRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryClaimableDisputeRewardsRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) New() protoreflect.Message {
	return new(fastReflection_QueryClaimableDisputeRewardsRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryClaimableDisputeRewardsRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.DisputeId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.DisputeId)
		if !f(fd_QueryClaimableDisputeRewardsRequest_dispute_id, value) {
			return
		}
	}
	if x.Address != "" {
		value := protoreflect.ValueOfString(x.Address)
		if !f(fd_QueryClaimableDisputeRewardsRequest_address, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.dispute_id":
		return x.DisputeId != uint64(0)
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.address":
		return x.Address != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryClaimableDisputeRewardsRequest"))
		}
		panic(fmt.Errorf("message layer.dispute.QueryClaimableDisputeRewardsRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.dispute_id":
		x.DisputeId = uint64(0)
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.address":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.dispute_id":
		value := x.DisputeId
		return protoreflect.ValueOfUint64(value)
	...
	default:
		...
		panic(fmt.Errorf("message layer.dispute.QueryClaimableDisputeRewardsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.dispute_id":
		x.DisputeId = value.Uint()
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.address":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.dispute_id":
		panic(fmt.Errorf("field dispute_id of message layer.dispute.QueryClaimableDisputeRewardsRequest is not mutable"))
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.address":
		panic(fmt.Errorf("field address of message layer.dispute.QueryClaimableDisputeRewardsRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryClaimableDisputeRewardsRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.dispute_id":
		return protoreflect.ValueOfUint64(uint64(0))
	case "layer.dispute.QueryClaimableDisputeRewardsRequest.address":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in layer.dispute.QueryClaimableDisputeRewardsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryClaimableDisputeRewardsRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryClaimableDisputeRewardsRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryClaimableDisputeRewardsRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryClaimableDisputeRewardsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
var (
	md_ClaimableAmount                   protoreflect.MessageDescriptor
	fd_ClaimableAmount_dispute_id        protoreflect.FieldDescriptor
	fd_ClaimableAmount_reward_amount     protoreflect.FieldDescriptor
	fd_ClaimableAmount_fee_refund_amount protoreflect.FieldDescriptor
	fd_ClaimableAmount_reward_claimed    protoreflect.FieldDescriptor
)

func init() {
	file_layer_dispute_query_proto_init()
	md_ClaimableAmount = File_layer_dispute_query_proto.Messages().ByName("ClaimableAmount")
	fd_ClaimableAmount_dispute_id = md_ClaimableAmount.Fields().ByName("dispute_id")
	fd_ClaimableAmount_reward_amount = md_ClaimableAmount.Fields().ByName("reward_amount")
	fd_ClaimableAmount_fee_refund_amount = md_ClaimableAmount.Fields().ByName("fee_refund_amount")
	fd_ClaimableAmount_reward_claimed = md_ClaimableAmount.Fields().ByName("reward_claimed")
}

var _ protoreflect.Message = (*fastReflection_ClaimableAmount)(nil)

type fastReflection_ClaimableAmount ClaimableAmount

func (x *ClaimableAmount) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ClaimableAmount)(x)
}

func (x *ClaimableAmount) slowProtoReflect() protoreflect.Message {
	mi := &file_layer_dispute_query_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_ClaimableAmount_messageType fastReflection_ClaimableAmount_messageType
var _ protoreflect.MessageType = fastReflection_ClaimableAmount_messageType{}

type fastReflection_ClaimableAmount_messageType struct{}

func (x fastReflection_ClaimableAmount_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ClaimableAmount)(nil)
}
func (x fastReflection_ClaimableAmount_messageType) New() protoreflect.Message {
	return new(fastReflection_ClaimableAmount)
}
func (x fastReflection_ClaimableAmount_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ClaimableAmount
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ClaimableAmount) Descriptor() protoreflect.MessageDescriptor {
	return md_ClaimableAmount
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ClaimableAmount) Type() protoreflect.MessageType {
	return _fastReflection_ClaimableAmount_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ClaimableAmount) New() protoreflect.Message {
	return new(fastReflection_ClaimableAmount)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ClaimableAmount) Interface() protoreflect.ProtoMessage {
	return (*ClaimableAmount)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ClaimableAmount) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.DisputeId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.DisputeId)
		if !f(fd_ClaimableAmount_dispute_id, value) {
			return
		}
	}
	if x.RewardAmount != "" {
		value := protoreflect.ValueOfString(x.RewardAmount)
		if !f(fd_ClaimableAmount_reward_amount, value) {
			return
		}
	}
	if x.FeeRefundAmount != "" {
		value := protoreflect.ValueOfString(x.FeeRefundAmount)
		if !f(fd_ClaimableAmount_fee_refund_amount, value) {
			return
		}
	}
	if x.RewardClaimed != false {
		value := protoreflect.ValueOfBool(x.RewardClaimed)
		if !f(fd_ClaimableAmount_reward_claimed, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ClaimableAmount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "layer.dispute.ClaimableAmount.dispute_id":
		return x.DisputeId != uint64(0)
	case "layer.dispute.ClaimableAmount.reward_amount":
		return x.RewardAmount != ""
	case "layer.dispute.ClaimableAmount.fee_refund_amount":
		return x.FeeRefundAmount != ""
	case "layer.dispute.ClaimableAmount.reward_claimed":
		return x.RewardClaimed != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.ClaimableAmount"))
		}
		panic(fmt.Errorf("message layer.dispute.ClaimableAmount does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ClaimableAmount) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "layer.dispute.ClaimableAmount.dispute_id":
		x.DisputeId = uint64(0)
	case "layer.dispute.ClaimableAmount.reward_amount":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ClaimableAmount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "layer.dispute.ClaimableAmount.dispute_id":
		value := x.DisputeId
		return protoreflect.ValueOfUint64(value)
	...
	default:
		...
		panic(fmt.Errorf("message layer.dispute.ClaimableAmount does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ClaimableAmount) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "layer.dispute.ClaimableAmount.dispute_id":
		x.DisputeId = value.Uint()
	case "layer.dispute.ClaimableAmount.reward_amount":
	...
	case "layer.dispute.ClaimableAmount.fee_refund_amount":
		x.FeeRefundAmount = value.Interface().(string)
	case "layer.dispute.ClaimableAmount.reward_claimed":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ClaimableAmount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.ClaimableAmount.dispute_id":
		panic(fmt.Errorf("field dispute_id of message layer.dispute.ClaimableAmount is not mutable"))
	case "layer.dispute.ClaimableAmount.reward_amount":
		panic(fmt.Errorf("field reward_amount of message layer.dispute.ClaimableAmount is not mutable"))
	case "layer.dispute.ClaimableAmount.fee_refund_amount":
		panic(fmt.Errorf("field fee_refund_amount of message layer.dispute.ClaimableAmount is not mutable"))
	case "layer.dispute.ClaimableAmount.reward_claimed":
		panic(fmt.Errorf("field reward_claimed of message layer.dispute.ClaimableAmount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.ClaimableAmount"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ClaimableAmount) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.ClaimableAmount.dispute_id":
		return protoreflect.ValueOfUint64(uint64(0))
	case "layer.dispute.ClaimableAmount.reward_amount":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ClaimableAmount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in layer.dispute.ClaimableAmount", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ClaimableAmount) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ClaimableAmount) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ClaimableAmount) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ClaimableAmount) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ClaimableAmount)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.FeeRefundAmount) > 0 {
			i -= len(x.FeeRefundAmount)
			copy(dAtA[i:], x.FeeRefundAmount)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.FeeRefundAmount)))
			i--
			dAtA[i] = 0x1a
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ClaimableAmount: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ClaimableAmount: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field FeeRefundAmount", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.FeeRefundAmount = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 4:
				if wireType != 0 {
...
var (
	md_QueryClaimableDisputeRewardsResponse                  protoreflect.MessageDescriptor
	fd_QueryClaimableDisputeRewardsResponse_claimable_amount protoreflect.FieldDescriptor
)

func init() {
	file_layer_dispute_query_proto_init()
	md_QueryClaimableDisputeRewardsResponse = File_layer_dispute_query_proto.Messages().ByName("QueryClaimableDisputeRewardsResponse")
	fd_QueryClaimableDisputeRewardsResponse_claimable_amount = md_QueryClaimableDisputeRewardsResponse.Fields().ByName("claimable_amount")
}

var _ protoreflect.Message = (*fastReflection_QueryClaimableDisputeRewardsResponse)(nil)

type fastReflection_QueryClaimableDisputeRewardsResponse QueryClaimableDisputeRewardsResponse

func (x *QueryClaimableDisputeRewardsResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryClaimableDisputeRewardsResponse)(x)
}

func (x *QueryClaimableDisputeRewardsResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_layer_dispute_query_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryClaimableDisputeRewardsResponse_messageType fastReflection_QueryClaimableDisputeRewardsResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryClaimableDisputeRewardsResponse_messageType{}

type fastReflection_QueryClaimableDisputeRewardsResponse_messageType struct{}

func (x fastReflection_QueryClaimableDisputeRewardsResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryClaimableDisputeRewardsResponse)(nil)
}
func (x fastReflection_QueryClaimableDisputeRewardsResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryClaimableDisputeRewardsResponse)
}
func (x fastReflection_QueryClaimableDisputeRewardsResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryClaimableDisputeRewardsResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryClaimableDisputeRewardsResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryClaimableDisputeRewardsResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) New() protoreflect.Message {
	return new(fastReflection_QueryClaimableDisputeRewardsResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryClaimableDisputeRewardsResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ClaimableAmount != nil {
		value := protoreflect.ValueOfMessage(x.ClaimableAmount.ProtoReflect())
		if !f(fd_QueryClaimableDisputeRewardsResponse_claimable_amount, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsResponse.claimable_amount":
		return x.ClaimableAmount != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryClaimableDisputeRewardsResponse"))
		}
		panic(fmt.Errorf("message layer.dispute.QueryClaimableDisputeRewardsResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsResponse.claimable_amount":
		x.ClaimableAmount = nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryClaimableDisputeRewardsResponse"))
		}
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsResponse.claimable_amount":
	...
	default:
		...
		panic(fmt.Errorf("message layer.dispute.QueryClaimableDisputeRewardsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsResponse.claimable_amount":
		x.ClaimableAmount = value.Message().Interface().(*ClaimableAmount)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryClaimableDisputeRewardsResponse"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsResponse.claimable_amount":
		if x.ClaimableAmount == nil {
			x.ClaimableAmount = new(ClaimableAmount)
		}
		return protoreflect.ValueOfMessage(x.ClaimableAmount.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryClaimableDisputeRewardsResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.dispute.QueryClaimableDisputeRewardsResponse.claimable_amount":
		m := new(ClaimableAmount)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.QueryClaimableDisputeRewardsResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in layer.dispute.QueryClaimableDisputeRewardsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryClaimableDisputeRewardsResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryClaimableDisputeRewardsResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		_ = l
		if x.ClaimableAmount != nil {
			l = options.Size(x.ClaimableAmount)
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.ClaimableAmount != nil {
			encoded, err := options.Marshal(x.ClaimableAmount)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryClaimableDisputeRewardsResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryClaimableDisputeRewardsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
				...
				if x.ClaimableAmount == nil {
					x.ClaimableAmount = &ClaimableAmount{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.ClaimableAmount); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
func (x *Disputes) GetMetadata() *DisputeStrings {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *QueryDisputeFeePayersRequest) Reset() {
	*x = QueryDisputeFeePayersRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layer_dispute_query_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryDisputeFeePayersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryDisputeFeePayersRequest) ProtoMessage() {}

// Deprecated: Use QueryDisputeFeePayersRequest.ProtoReflect.Descriptor instead.
func (*QueryDisputeFeePayersRequest) Descriptor() ([]byte, []int) {
	return file_layer_dispute_query_proto_rawDescGZIP(), []int{17}
}

func (x *QueryDisputeFeePayersRequest) GetDisputeId() uint64 {
	if x != nil {
		return x.DisputeId
	}
	return 0
...
type DisputeFeePayerInfo struct {
	...
	PayerInfo    *PayerInfo `protobuf:"bytes,2,opt,name=payer_info,json=payerInfo,proto3" json:"payer_info,omitempty"`
}

func (x *DisputeFeePayerInfo) Reset() {
	*x = DisputeFeePayerInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layer_dispute_query_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *DisputeFeePayerInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DisputeFeePayerInfo) ProtoMessage() {}

// Deprecated: Use DisputeFeePayerInfo.ProtoReflect.Descriptor instead.
func (*DisputeFeePayerInfo) Descriptor() ([]byte, []int) {
	return file_layer_dispute_query_proto_rawDescGZIP(), []int{18}
}

func (x *DisputeFeePayerInfo) GetPayerAddress() string {
	if x != nil {
		return x.PayerAddress
	}
	return ""
...
func (x *DisputeFeePayerInfo) GetPayerInfo() *PayerInfo {
	if x != nil {
		return x.PayerInfo
	}
	return nil
...
func (x *QueryDisputeFeePayersResponse) Reset() {
	*x = QueryDisputeFeePayersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layer_dispute_query_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryDisputeFeePayersResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryDisputeFeePayersResponse) ProtoMessage() {}

// Deprecated: Use QueryDisputeFeePayersResponse.ProtoReflect.Descriptor instead.
func (*QueryDisputeFeePayersResponse) Descriptor() ([]byte, []int) {
	return file_layer_dispute_query_proto_rawDescGZIP(), []int{19}
}

func (x *QueryDisputeFeePayersResponse) GetPayers() []*DisputeFeePayerInfo {
	if x != nil {
		return x.Payers
	}
	return nil
...
func (x *QueryClaimableDisputeRewardsRequest) Reset() {
	*x = QueryClaimableDisputeRewardsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layer_dispute_query_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryClaimableDisputeRewardsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryClaimableDisputeRewardsRequest) ProtoMessage() {}

// Deprecated: Use QueryClaimableDisputeRewardsRequest.ProtoReflect.Descriptor instead.
func (*QueryClaimableDisputeRewardsRequest) Descriptor() ([]byte, []int) {
	return file_layer_dispute_query_proto_rawDescGZIP(), []int{20}
}

func (x *QueryClaimableDisputeRewardsRequest) GetDisputeId() uint64 {
	if x != nil {
		return x.DisputeId
	}
	return 0
...
func (x *QueryClaimableDisputeRewardsRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
type ClaimableAmount struct {
	...
	FeeRefundAmount string `protobuf:"bytes,3,opt,name=fee_refund_amount,json=feeRefundAmount,proto3" json:"fee_refund_amount,omitempty"`
	RewardClaimed   bool   `protobuf:"varint,4,opt,name=reward_claimed,json=rewardClaimed,proto3" json:"reward_claimed,omitempty"`
}

func (x *ClaimableAmount) Reset() {
	*x = ClaimableAmount{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layer_dispute_query_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *ClaimableAmount) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClaimableAmount) ProtoMessage() {}

// Deprecated: Use ClaimableAmount.ProtoReflect.Descriptor instead.
func (*ClaimableAmount) Descriptor() ([]byte, []int) {
	return file_layer_dispute_query_proto_rawDescGZIP(), []int{21}
}

func (x *ClaimableAmount) GetDisputeId() uint64 {
	if x != nil {
		return x.DisputeId
	}
	return 0
...
func (x *ClaimableAmount) GetRewardAmount() string {
	if x != nil {
		return x.RewardAmount
	}
	return ""
...
func (x *ClaimableAmount) GetFeeRefundAmount() string {
	if x != nil {
		return x.FeeRefundAmount
	}
	return ""
...
func (x *ClaimableAmount) GetRewardClaimed() bool {
	if x != nil {
...
func (x *QueryClaimableDisputeRewardsResponse) Reset() {
	*x = QueryClaimableDisputeRewardsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layer_dispute_query_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryClaimableDisputeRewardsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryClaimableDisputeRewardsResponse) ProtoMessage() {}

// Deprecated: Use QueryClaimableDisputeRewardsResponse.ProtoReflect.Descriptor instead.
func (*QueryClaimableDisputeRewardsResponse) Descriptor() ([]byte, []int) {
	return file_layer_dispute_query_proto_rawDescGZIP(), []int{22}
}

func (x *QueryClaimableDisputeRewardsResponse) GetClaimableAmount() *ClaimableAmount {
	if x != nil {
...
var file_layer_dispute_query_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x63, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x49, 0x0a, 0x11, 0x66, 0x65, 0x65, 0x5f, 0x72, 0x65, 0x66,
	0x75, 0x6e, 0x64, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	...
	,
	...
	0x64, 0x69, 0x73, 0x70, 0x75, 0x74, 0x65, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x80,
	0x01, 0x0a, 0x08, 0x44, 0x69, 0x73, 0x70, 0x75, 0x74, 0x65, 0x73, 0x12, 0x23, 0x2e, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x2e, 0x64, 0x69, 0x73, 0x70, 0x75, 0x74, 0x65, 0x2e, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x44, 0x69, 0x73, 0x70, 0x75, 0x74, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x24, 0x2e, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x64, 0x69, 0x73, 0x70, 0x75, 0x74, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_layer_dispute_query_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_layer_dispute_query_proto_goTypes = []interface{}{
	...
	(*QueryDisputeFeePayersRequest)(nil),         // 17: layer.dispute.QueryDisputeFeePayersRequest
	(*DisputeFeePayerInfo)(nil),                  // 18: layer.dispute.DisputeFeePayerInfo
	(*QueryDisputeFeePayersResponse)(nil),        // 19: layer.dispute.QueryDisputeFeePayersResponse
	(*QueryClaimableDisputeRewardsRequest)(nil),  // 20: layer.dispute.QueryClaimableDisputeRewardsRequest
	(*ClaimableAmount)(nil),                      // 21: layer.dispute.ClaimableAmount
	(*QueryClaimableDisputeRewardsResponse)(nil), // 22: layer.dispute.QueryClaimableDisputeRewardsResponse
	(*Params)(nil),                               // 23: layer.dispute.Params
	(*v1beta1.PageRequest)(nil),                  // 24: cosmos.base.query.v1beta1.PageRequest
	(*DisputeStrings)(nil),                       // 25: layer.dispute.DisputeStrings
	(*v1beta1.PageResponse)(nil),                 // 26: cosmos.base.query.v1beta1.PageResponse
	(*OpenDisputes)(nil),                         // 27: layer.dispute.OpenDisputes
	(*Voter)(nil),                                // 28: layer.dispute.Voter
	(*GroupTally)(nil),                           // 29: layer.dispute.GroupTally
	(*FormattedVoteCounts)(nil),                  // 30: layer.dispute.FormattedVoteCounts
	(*CombinedTotal)(nil),                        // 31: layer.dispute.CombinedTotal
	(VoteResult)(0),                              // 32: layer.dispute.VoteResult
	(*PayerInfo)(nil),                            // 33: layer.dispute.PayerInfo
}
var file_layer_dispute_query_proto_depIdxs = []int32{
	23, // 0: layer.dispute.QueryParamsResponse.params:type_name -> layer.dispute.Params
	24, // 1: layer.dispute.QueryDisputesRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	25, // 2: layer.dispute.Disputes.metadata:type_name -> layer.dispute.DisputeStrings
	26, // 3: layer.dispute.QueryDisputesResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	...
	27, // 6: layer.dispute.QueryOpenDisputesResponse.openDisputes:type_name -> layer.dispute.OpenDisputes
	28, // 7: layer.dispute.QueryTeamVoteResponse.team_vote:type_name -> layer.dispute.Voter
	29, // 8: layer.dispute.QueryDisputesTallyResponse.users:type_name -> layer.dispute.GroupTally
	29, // 9: layer.dispute.QueryDisputesTallyResponse.reporters:type_name -> layer.dispute.GroupTally
	30, // 10: layer.dispute.QueryDisputesTallyResponse.team:type_name -> layer.dispute.FormattedVoteCounts
	31, // 11: layer.dispute.QueryDisputesTallyResponse.combinedTotal:type_name -> layer.dispute.CombinedTotal
	32, // 12: layer.dispute.QueryDisputeVoteResultResponse.vote_result:type_name -> layer.dispute.VoteResult
	33, // 13: layer.dispute.DisputeFeePayerInfo.payer_info:type_name -> layer.dispute.PayerInfo
	18, // 14: layer.dispute.QueryDisputeFeePayersResponse.payers:type_name -> layer.dispute.DisputeFeePayerInfo
	21, // 15: layer.dispute.QueryClaimableDisputeRewardsResponse.claimable_amount:type_name -> layer.dispute.ClaimableAmount
	0,  // 16: layer.dispute.Query.Params:input_type -> layer.dispute.QueryParamsRequest
	2,  // 17: layer.dispute.Query.Disputes:input_type -> layer.dispute.QueryDisputesRequest
	5,  // 18: layer.dispute.Query.Dispute:input_type -> layer.dispute.QueryDisputeRequest
	7,  // 19: layer.dispute.Query.OpenDisputes:input_type -> layer.dispute.QueryOpenDisputesRequest
	9,  // 20: layer.dispute.Query.TeamVote:input_type -> layer.dispute.QueryTeamVoteRequest
	11, // 21: layer.dispute.Query.TeamAddress:input_type -> layer.dispute.QueryTeamAddressRequest
	13, // 22: layer.dispute.Query.Tally:input_type -> layer.dispute.QueryDisputesTallyRequest
	15, // 23: layer.dispute.Query.VoteResult:input_type -> layer.dispute.QueryDisputeVoteResultRequest
	17, // 24: layer.dispute.Query.DisputeFeePayers:input_type -> layer.dispute.QueryDisputeFeePayersRequest
	20, // 25: layer.dispute.Query.ClaimableDisputeRewards:input_type -> layer.dispute.QueryClaimableDisputeRewardsRequest
	1,  // 26: layer.dispute.Query.Params:output_type -> layer.dispute.QueryParamsResponse
	4,  // 27: layer.dispute.Query.Disputes:output_type -> layer.dispute.QueryDisputesResponse
	6,  // 28: layer.dispute.Query.Dispute:output_type -> layer.dispute.QueryDisputeResponse
	8,  // 29: layer.dispute.Query.OpenDisputes:output_type -> layer.dispute.QueryOpenDisputesResponse
	10, // 30: layer.dispute.Query.TeamVote:output_type -> layer.dispute.QueryTeamVoteResponse
	12, // 31: layer.dispute.Query.TeamAddress:output_type -> layer.dispute.QueryTeamAddressResponse
	14, // 32: layer.dispute.Query.Tally:output_type -> layer.dispute.QueryDisputesTallyResponse
	16, // 33: layer.dispute.Query.VoteResult:output_type -> layer.dispute.QueryDisputeVoteResultResponse
	19, // 34: layer.dispute.Query.DisputeFeePayers:output_type -> layer.dispute.QueryDisputeFeePayersResponse
	22, // 35: layer.dispute.Query.ClaimableDisputeRewards:output_type -> layer.dispute.QueryClaimableDisputeRewardsResponse
...
func file_layer_dispute_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_layer_dispute_query_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryDisputeFeePayersRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_layer_dispute_query_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DisputeFeePayerInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_layer_dispute_query_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryDisputeFeePayersResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_layer_dispute_query_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryClaimableDisputeRewardsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_layer_dispute_query_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClaimableAmount); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_layer_dispute_query_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryClaimableDisputeRewardsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
