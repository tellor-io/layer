...
func (x *fastReflection_MicroReport) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "layer.dispute.MicroReport.query_type":
		return x.QueryType != ""
	case "layer.dispute.MicroReport.query_id":
		return x.QueryId != ""
	case "layer.dispute.MicroReport.aggregate_method":
		return x.AggregateMethod != ""
	case "layer.dispute.MicroReport.value":
		return x.Value != ""
	case "layer.dispute.MicroReport.block_number":
...
func (x *fastReflection_MicroReport) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "layer.dispute.MicroReport.query_type":
		panic(fmt.Errorf("field query_type of message layer.dispute.MicroReport is not mutable"))
	case "layer.dispute.MicroReport.query_id":
		panic(fmt.Errorf("field query_id of message layer.dispute.MicroReport is not mutable"))
	case "layer.dispute.MicroReport.aggregate_method":
		panic(fmt.Errorf("field aggregate_method of message layer.dispute.MicroReport is not mutable"))
	case "layer.dispute.MicroReport.value":
		panic(fmt.Errorf("field value of message layer.dispute.MicroReport is not mutable"))
	case "layer.dispute.MicroReport.block_number":
		panic(fmt.Errorf("field block_number of message layer.dispute.MicroReport is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.dispute.MicroReport"))
		}
...
var file_layer_dispute_dispute_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x22, 0xa1, 0x02, 0x0a, 0x0b, 0x4d, 0x69, 0x63, 0x72, 0x6f, 0x52, 0x65, 0x70, 0x6f,
	...
	0x6f, 0x77, 0x65, 0x72, 0x12, 0x1d, 0x0a, 0x0a, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x71, 0x75, 0x65, 0x72, 0x79, 0x54,
	0x79, 0x70, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x69, 0x64, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x71, 0x75, 0x65, 0x72, 0x79, 0x49, 0x64, 0x12, 0x29,
	0x0a, 0x10, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x5f, 0x6d, 0x65, 0x74, 0x68,
	0x6f, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67,
	0x61, 0x74, 0x65, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
...
var file_layer_dispute_dispute_proto_depIdxs = []int32{
	...
	5, // 6: layer.dispute.MicroReport.timestamp:type_name -> google.protobuf.Timestamp
	6, // 7: layer.dispute.PayerInfo.amount:type_name -> cosmos.base.v1beta1.Coin
