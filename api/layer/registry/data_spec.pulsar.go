...
func (x *_DataSpec_3_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message DataSpec at list field QueryParameterTypes as it is not of Message kind"))
}
...
var (
	...
	fd_DataSpec_query_parameter_types protoreflect.FieldDescriptor
...
func init() {
	...
	fd_DataSpec_query_parameter_types = md_DataSpec.Fields().ByName("query_parameter_types")
...
func (x *fastReflection_DataSpec) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.QueryParameterTypes) != 0 {
		value := protoreflect.ValueOfList(&_DataSpec_3_list{list: &x.QueryParameterTypes})
		if !f(fd_DataSpec_query_parameter_types, value) {
			return
		}
	}
...
func (x *fastReflection_DataSpec) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "layer.registry.DataSpec.value_type":
		return x.ValueType != ""
	case "layer.registry.DataSpec.query_parameter_types":
		return len(x.QueryParameterTypes) != 0
...
func (x *fastReflection_DataSpec) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "layer.registry.DataSpec.query_parameter_types":
		...
		listValue := &_DataSpec_3_list{list: &x.QueryParameterTypes}
...
func (x *fastReflection_DataSpec) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "layer.registry.DataSpec.query_parameter_types":
		...
		x.QueryParameterTypes = *clv.list
	case "layer.registry.DataSpec.aggregation_method":
...
func (x *fastReflection_DataSpec) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "layer.registry.DataSpec.query_parameter_types":
		if x.QueryParameterTypes == nil {
			x.QueryParameterTypes = []string{}
		}
		value := &_DataSpec_3_list{list: &x.QueryParameterTypes}
...
func (x *fastReflection_DataSpec) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.QueryParameterTypes) > 0 {
			for _, s := range x.QueryParameterTypes {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.QueryParameterTypes) > 0 {
			for iNdEx := len(x.QueryParameterTypes) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.QueryParameterTypes[iNdEx])
				copy(dAtA[i:], x.QueryParameterTypes[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.QueryParameterTypes[iNdEx])))
				i--
				dAtA[i] = 0x1a
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field QueryParameterTypes", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.QueryParameterTypes = append(x.QueryParameterTypes, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 4:
				if wireType != 2 {
...
func (x *DataSpec) GetQueryParameterTypes() []string {
	if x != nil {
...
var file_layer_registry_data_spec_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc5, 0x02, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x53, 0x70, 0x65,
	...
	,
