...
var file_layer_oracle_query_proto_rawDesc = []byte{
	...
	0x32, 0xe2, 0x1c, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x6b, 0x0a, 0x06, 0x50, 0x61,
	...
	,
	...
	0x61, 0x74, 0x61, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0xc7, 0x01, 0x0a, 0x15, 0x52, 0x65,
...
var file_layer_oracle_query_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_layer_oracle_query_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                                    // 40: layer.oracle.Params
	(*MicroReport)(nil),                               // 41: layer.oracle.MicroReport
	...
	(*Aggregate)(nil),                                 // 44: layer.oracle.Aggregate
	(*v1beta11.Coin)(nil),                             // 45: cosmos.base.v1beta1.Coin
	(*QueryMeta)(nil),                                 // 46: layer.oracle.QueryMeta
}
var file_layer_oracle_query_proto_depIdxs = []int32{
	40, // 0: layer.oracle.QueryParamsResponse.params:type_name -> layer.oracle.Params
	41, // 1: layer.oracle.QueryMicroReportsResponse.microReports:type_name -> layer.oracle.MicroReport
	42, // 2: layer.oracle.QueryMicroReportsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	43, // 3: layer.oracle.QueryGetReportsbyQidRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	43, // 4: layer.oracle.QueryGetReportsbyReporterRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	43, // 5: layer.oracle.QueryGetReportsbyReporterQidRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	44, // 6: layer.oracle.QueryGetDataBeforeResponse.aggregate:type_name -> layer.oracle.Aggregate
	44, // 7: layer.oracle.QueryGetDataAfterResponse.aggregate:type_name -> layer.oracle.Aggregate
	45, // 8: layer.oracle.QueryGetTimeBasedRewardsResponse.reward:type_name -> cosmos.base.v1beta1.Coin
	46, // 9: layer.oracle.QueryCurrentCyclelistQueryResponse.query_meta:type_name -> layer.oracle.QueryMeta
	46, // 10: layer.oracle.QueryNextCyclelistQueryResponse.query_meta:type_name -> layer.oracle.QueryMeta
	44, // 11: layer.oracle.QueryRetrieveDataResponse.aggregate:type_name -> layer.oracle.Aggregate
	44, // 12: layer.oracle.QueryGetCurrentAggregateReportResponse.aggregate:type_name -> layer.oracle.Aggregate
	44, // 13: layer.oracle.QueryGetAggregateBeforeByReporterResponse.aggregate:type_name -> layer.oracle.Aggregate
	46, // 14: layer.oracle.QueryGetQueryResponse.query:type_name -> layer.oracle.QueryMeta
	43, // 15: layer.oracle.QueryTippedQueriesRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	46, // 16: layer.oracle.QueryTippedQueriesResponse.queries:type_name -> layer.oracle.QueryMeta
	43, // 17: layer.oracle.QueryGetReportsByAggregateRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	41, // 18: layer.oracle.QueryGetReportsByAggregateResponse.microReports:type_name -> layer.oracle.MicroReport
	42, // 19: layer.oracle.QueryGetReportsByAggregateResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	46, // 20: layer.oracle.QueryGetCurrentQueryByQueryIdResponse.query:type_name -> layer.oracle.QueryMeta
	43, // 21: layer.oracle.QueryReportedIdsByReporterRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	42, // 22: layer.oracle.QueryReportedIdsByReporterResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	...
	1,  // 44: layer.oracle.Query.Params:output_type -> layer.oracle.QueryParamsResponse
	2,  // 45: layer.oracle.Query.GetReportsbyQid:output_type -> layer.oracle.QueryMicroReportsResponse
	2,  // 46: layer.oracle.Query.GetReportsbyReporter:output_type -> layer.oracle.QueryMicroReportsResponse
	2,  // 47: layer.oracle.Query.GetReportsbyReporterQid:output_type -> layer.oracle.QueryMicroReportsResponse
	7,  // 48: layer.oracle.Query.GetCurrentTip:output_type -> layer.oracle.QueryGetCurrentTipResponse
	9,  // 49: layer.oracle.Query.GetUserTipTotal:output_type -> layer.oracle.QueryGetUserTipTotalResponse
	11, // 50: layer.oracle.Query.GetDataBefore:output_type -> layer.oracle.QueryGetDataBeforeResponse
	13, // 51: layer.oracle.Query.GetDataAfter:output_type -> layer.oracle.QueryGetDataAfterResponse
	15, // 52: layer.oracle.Query.GetTimeBasedRewards:output_type -> layer.oracle.QueryGetTimeBasedRewardsResponse
	17, // 53: layer.oracle.Query.CurrentCyclelistQuery:output_type -> layer.oracle.QueryCurrentCyclelistQueryResponse
	19, // 54: layer.oracle.Query.NextCyclelistQuery:output_type -> layer.oracle.QueryNextCyclelistQueryResponse
	21, // 55: layer.oracle.Query.RetrieveData:output_type -> layer.oracle.QueryRetrieveDataResponse
	23, // 56: layer.oracle.Query.GetCurrentAggregateReport:output_type -> layer.oracle.QueryGetCurrentAggregateReportResponse
	25, // 57: layer.oracle.Query.GetAggregateBeforeByReporter:output_type -> layer.oracle.QueryGetAggregateBeforeByReporterResponse
	27, // 58: layer.oracle.Query.GetQuery:output_type -> layer.oracle.QueryGetQueryResponse
	29, // 59: layer.oracle.Query.TippedQueries:output_type -> layer.oracle.QueryTippedQueriesResponse
	31, // 60: layer.oracle.Query.GetReportsByAggregate:output_type -> layer.oracle.QueryGetReportsByAggregateResponse
	33, // 61: layer.oracle.Query.GetCurrentQueryByQueryId:output_type -> layer.oracle.QueryGetCurrentQueryByQueryIdResponse
	35, // 62: layer.oracle.Query.GetQueryDataLimit:output_type -> layer.oracle.QueryGetQueryDataLimitResponse
	37, // 63: layer.oracle.Query.ReportedIdsByReporter:output_type -> layer.oracle.QueryReportedIdsByReporterResponse
	39, // 64: layer.oracle.Query.GetCycleList:output_type -> layer.oracle.QueryGetCycleListResponse
