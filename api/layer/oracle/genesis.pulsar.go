...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "layer.oracle.GenesisState.port_id":
		return x.PortId != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "layer.oracle.GenesisState.port_id":
		panic(fmt.Errorf("field port_id of message layer.oracle.GenesisState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.oracle.GenesisState"))
		}
...
var file_layer_oracle_genesis_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7f, 0x0a, 0x0c, 0x47,
	...
	0x69, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x64, 0x42, 0x9e, 0x01, 0x0a,
