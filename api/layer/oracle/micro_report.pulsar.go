...
var (
	...
	fd_MicroReport_meta_id          protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MicroReport_meta_id = md_MicroReport.Fields().ByName("meta_id")
}
...
func (x *fastReflection_MicroReport) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.MetaId != uint64(0) {
		...
		if !f(fd_MicroReport_meta_id, value) {
			return
		}
	}
}
...
func (x *fastReflection_MicroReport) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "layer.oracle.MicroReport.meta_id":
...
func (x *fastReflection_MicroReport) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "layer.oracle.MicroReport.meta_id":
		panic(fmt.Errorf("field meta_id of message layer.oracle.MicroReport is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: layer.oracle.MicroReport"))
		}
...
func (x *MicroReport) GetMetaId() uint64 {
	if x != nil {
		return x.MetaId
	}
	return 0
...
var file_layer_oracle_micro_report_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd8, 0x02, 0x0a, 0x0b, 0x4d, 0x69, 0x63, 0x72, 0x6f,
	...
	0x63, 0x6b, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x17, 0x0a, 0x07, 0x6d, 0x65, 0x74, 0x61,
	0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x6d, 0x65, 0x74, 0x61, 0x49,
	0x64, 0x22, 0x70, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x72,
	0x6f, 0x73, 0x73, 0x6f, 0x76, 0x65, 0x72, 0x5f, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x0f, 0x63, 0x72, 0x6f, 0x73, 0x73, 0x6f, 0x76, 0x65, 0x72, 0x57,
	0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x3c, 0x0a, 0x0c, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x5f, 0x72,
