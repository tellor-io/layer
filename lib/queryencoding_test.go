...
func TestEncodeArguments(t *testing.T) {
	...
	dataFields := []string{"eth", "usd"}

	res, err := EncodeArguments(dataTypes, dataFields)
	require.NoError(t, err)
	queryType := []string{"string", "bytes"}
	queryTypeField := []string{"SpotPrice", string(res)}
	res2, err := EncodeArguments(queryType, queryTypeField)
	require.NoError(t, err)
	qdata := hex.EncodeToString(res2)
	expectedQueryData := ""
	require.Equal(t, expectedQueryData, qdata)
}
