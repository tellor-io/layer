...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"tellor-io", "layer", "bridge", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GetEvmValidators_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"tellor-io", "layer", "bridge", "get_evm_validators"}, "", runtime.AssumeColonVerbOpt(true)))
)
