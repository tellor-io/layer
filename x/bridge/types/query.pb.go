...
func (m *QueryGetAttestationDataBySnapshotResponse) GetLastConsensusTimestamp() string {
	if m != nil {
...
func (m *QueryGetDepositClaimedRequest) Reset()         { *m = QueryGetDepositClaimedRequest{} }
func (m *QueryGetDepositClaimedRequest) String() string { return proto.CompactTextString(m) }
func (*QueryGetDepositClaimedRequest) ProtoMessage()    {}
func (*QueryGetDepositClaimedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e48df680904493de, []int{35}
}
func (m *QueryGetDepositClaimedRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetDepositClaimedRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetDepositClaimedRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetDepositClaimedRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetDepositClaimedRequest.Merge(m, src)
}
func (m *QueryGetDepositClaimedRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetDepositClaimedRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetDepositClaimedRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetDepositClaimedRequest proto.InternalMessageInfo

func (m *QueryGetDepositClaimedRequest) GetDepositId() uint64 {
	if m != nil {
		return m.DepositId
	}
	return 0
...
func (m *QueryGetDepositClaimedResponse) Reset()         { *m = QueryGetDepositClaimedResponse{} }
func (m *QueryGetDepositClaimedResponse) String() string { return proto.CompactTextString(m) }
func (*QueryGetDepositClaimedResponse) ProtoMessage()    {}
func (*QueryGetDepositClaimedResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e48df680904493de, []int{36}
}
func (m *QueryGetDepositClaimedResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetDepositClaimedResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetDepositClaimedResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetDepositClaimedResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetDepositClaimedResponse.Merge(m, src)
}
func (m *QueryGetDepositClaimedResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetDepositClaimedResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetDepositClaimedResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetDepositClaimedResponse proto.InternalMessageInfo

func (m *QueryGetDepositClaimedResponse) GetClaimed() bool {
	if m != nil {
		return m.Claimed
	}
	return false
...
func (m *QueryGetLastWithdrawalIdRequest) Reset()         { *m = QueryGetLastWithdrawalIdRequest{} }
func (m *QueryGetLastWithdrawalIdRequest) String() string { return proto.CompactTextString(m) }
func (*QueryGetLastWithdrawalIdRequest) ProtoMessage()    {}
func (*QueryGetLastWithdrawalIdRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e48df680904493de, []int{37}
}
func (m *QueryGetLastWithdrawalIdRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetLastWithdrawalIdRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetLastWithdrawalIdRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetLastWithdrawalIdRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetLastWithdrawalIdRequest.Merge(m, src)
}
func (m *QueryGetLastWithdrawalIdRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetLastWithdrawalIdRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetLastWithdrawalIdRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetLastWithdrawalIdRequest proto.InternalMessageInfo
...
func (m *QueryGetLastWithdrawalIdResponse) Reset()         { *m = QueryGetLastWithdrawalIdResponse{} }
func (m *QueryGetLastWithdrawalIdResponse) String() string { return proto.CompactTextString(m) }
func (*QueryGetLastWithdrawalIdResponse) ProtoMessage()    {}
func (*QueryGetLastWithdrawalIdResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e48df680904493de, []int{38}
}
func (m *QueryGetLastWithdrawalIdResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetLastWithdrawalIdResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetLastWithdrawalIdResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetLastWithdrawalIdResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetLastWithdrawalIdResponse.Merge(m, src)
}
func (m *QueryGetLastWithdrawalIdResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetLastWithdrawalIdResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetLastWithdrawalIdResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetLastWithdrawalIdResponse proto.InternalMessageInfo

func (m *QueryGetLastWithdrawalIdResponse) GetWithdrawalId() uint64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*QueryGetDepositClaimedRequest)(nil), "layer.bridge.QueryGetDepositClaimedRequest")
	proto.RegisterType((*QueryGetDepositClaimedResponse)(nil), "layer.bridge.QueryGetDepositClaimedResponse")
	proto.RegisterType((*QueryGetLastWithdrawalIdRequest)(nil), "layer.bridge.QueryGetLastWithdrawalIdRequest")
	proto.RegisterType((*QueryGetLastWithdrawalIdResponse)(nil), "layer.bridge.QueryGetLastWithdrawalIdResponse")
}
...
var fileDescriptor_e48df680904493de = []byte{
	...
	,
}
...
func (*UnimplementedQueryServer) GetDepositClaimed(ctx context.Context, req *QueryGetDepositClaimedRequest) (*QueryGetDepositClaimedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDepositClaimed not implemented")
}
func (*UnimplementedQueryServer) GetLastWithdrawalId(ctx context.Context, req *QueryGetLastWithdrawalIdRequest) (*QueryGetLastWithdrawalIdResponse, error) {
...
func (m *QueryGetAttestationDataBySnapshotResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.LastConsensusTimestamp) > 0 {
		i -= len(m.LastConsensusTimestamp)
		copy(dAtA[i:], m.LastConsensusTimestamp)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.LastConsensusTimestamp)))
		i--
		dAtA[i] = 0x4a
	}
...
func (m *QueryGetDepositClaimedRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetDepositClaimedRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetDepositClaimedRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGetDepositClaimedResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetDepositClaimedResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetDepositClaimedResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGetLastWithdrawalIdRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetLastWithdrawalIdRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetLastWithdrawalIdRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGetLastWithdrawalIdResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetLastWithdrawalIdResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetLastWithdrawalIdResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGetAttestationDataBySnapshotResponse) Size() (n int) {
	...
	l = len(m.LastConsensusTimestamp)
	if l > 0 {
		n += 1 + l + sovQuery(uint64(l))
	}
	return n
...
func (m *QueryGetDepositClaimedRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetDepositClaimedResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetLastWithdrawalIdRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetLastWithdrawalIdResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetAttestationDataBySnapshotResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.LastConsensusTimestamp = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
...
func (m *QueryGetDepositClaimedRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetDepositClaimedRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetDepositClaimedRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryGetDepositClaimedResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetDepositClaimedResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetDepositClaimedResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryGetLastWithdrawalIdRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetLastWithdrawalIdRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetLastWithdrawalIdRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QueryGetLastWithdrawalIdResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetLastWithdrawalIdResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetLastWithdrawalIdResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
