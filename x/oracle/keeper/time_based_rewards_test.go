...
func TestCalculateRewardAmount(t *testing.T) {
	testCases := []struct {
		name           string
		reporter       []keeper.ValidatorReportCount
	...
	}{
		{
			...
			reporter:       []keeper.ValidatorReportCount{{Power: 10, Reports: 1}, {Power: 20, Reports: 1}, {Power: 30, Reports: 1}, {Power: 40, Reports: 1}},
		...
		{
			name:           "only 1 reports",
			reporter:       []keeper.ValidatorReportCount{{Power: 10, Reports: 1}, {Power: 20, Reports: 0}, {Power: 30, Reports: 0}, {Power: 40, Reports: 0}},
		...
		},
		{
			...
			reporter:       []keeper.ValidatorReportCount{{Power: 10, Reports: 1}, {Power: 20, Reports: 0}, {Power: 30, Reports: 1}, {Power: 40, Reports: 0}},
		...
		},
		{
			...
			reporter:       []keeper.ValidatorReportCount{{Power: 10, Reports: 2}, {Power: 20, Reports: 2}, {Power: 30, Reports: 2}, {Power: 40, Reports: 2}},
			expectedAmount: []math.Int{math.NewInt(10), math.NewInt(20), math.NewInt(30), math.NewInt(40)},
			totalPower:     200,
		},
		{
			name:           "all reporters report single, and 1 reports two queryIds",
			reporter:       []keeper.ValidatorReportCount{{Power: 10, Reports: 2}, {Power: 20, Reports: 1}, {Power: 30, Reports: 1}, {Power: 40, Reports: 1}},
		...
		},
		{
			...
			reporter:       []keeper.ValidatorReportCount{{Power: 10, Reports: 2}, {Power: 20, Reports: 1}, {Power: 30, Reports: 2}, {Power: 40, Reports: 1}},
