...
const (
	...
	// valid bridge deposit value
	bridgeDepositValue = ""
)
...
func (s *KeeperTestSuite) TestAddReportWeightedMode() {
	queryId, err := hex.DecodeString("57e934f27d9b60211c74816849e4b023246dd40a8ce6c1a7006f287ff10069ad")
	s.NoError(err)
	report := types.MicroReport{
		QueryId:         queryId,
		AggregateMethod: "weighted-mode",
	}

	correctValue := ""
	outlierValue := ""

	var metaId uint64 = 200
	reports := []struct {
		value string
		power uint64
	}{
	...
	for _, r := range reports {
		...
		report.Power = r.power
		s.NoError(s.oracleKeeper.AddReportWeightedMode(s.ctx, metaId, report))
	}

	agg, err := s.oracleKeeper.AggregateValue.Get(s.ctx, metaId)
	s.NoError(err)
	// correct value should win, total power 17112 vs outlier power 3626
	s.Equal(correctValue, agg.Value)
	s.Equal(uint64(17112), agg.CrossoverWeight)

	outlierValue2 := ""
	metaId = 201
	reports = []struct {
		value string
		power uint64
	...
	aggLarge, err := s.oracleKeeper.AggregateValue.Get(s.ctx, metaId)
	s.NoError(err)

	s.Equal(correctValue, aggLarge.Value)
	s.Equal(uint64(17_112), aggLarge.CrossoverWeight)
}
