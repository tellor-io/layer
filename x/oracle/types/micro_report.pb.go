...
func (m *ValueStored) Reset()         { *m = ValueStored{} }
func (m *ValueStored) String() string { return proto.CompactTextString(m) }
func (*ValueStored) ProtoMessage()    {}
func (*ValueStored) Descriptor() ([]byte, []int) {
	return fileDescriptor_c39350954f878191, []int{1}
}
func (m *ValueStored) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ValueStored) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ValueStored.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ValueStored) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValueStored.Merge(m, src)
}
func (m *ValueStored) XXX_Size() int {
	return m.Size()
}
func (m *ValueStored) XXX_DiscardUnknown() {
	xxx_messageInfo_ValueStored.DiscardUnknown(m)
}

var xxx_messageInfo_ValueStored proto.InternalMessageInfo

func (m *ValueStored) GetCumulativePower() uint64 {
	if m != nil {
		return m.CumulativePower
	}
	return 0
}

func (m *ValueStored) GetReport() *MicroReport {
	if m != nil {
		return m.Report
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ValueStored)(nil), "layer.oracle.ValueStored")
}
...
var fileDescriptor_c39350954f878191 = []byte{
	...
	,
}
...
func (m *ValueStored) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ValueStored) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValueStored) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.CumulativePower != 0 {
		i = encodeVarintMicroReport(dAtA, i, uint64(m.CumulativePower))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ValueStored) Size() (n int) {
	...
	_ = l
	if m.CumulativePower != 0 {
		n += 1 + sovMicroReport(uint64(m.CumulativePower))
	}
	if m.Report != nil {
		l = m.Report.Size()
		n += 1 + l + sovMicroReport(uint64(l))
...
func (m *ValueStored) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValueStored: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValueStored: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CumulativePower", wireType)
			}
			m.CumulativePower = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CumulativePower |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
