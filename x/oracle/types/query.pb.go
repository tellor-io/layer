...
type QueryGetTippedQueriesResponse struct {
	// querymeta but string query data for active queries
	...
	// querymeta but string query data for expired queries with tips
	...
	// available_tips_total defines the total available tips.
	AvailableTipsTotal cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=available_tips_total,json=availableTipsTotal,proto3,customtype=cosmossdk.io/math.Int" json:"available_tips_total"`
	// pagination defines the pagination in the response.
...
func (m *QueryGetTippedQueriesResponse) GetActiveQueries() []*QueryMetaButString {
	if m != nil {
...
func (m *QueryGetTippedQueriesResponse) GetExpiredQueries() []*QueryMetaButString {
	if m != nil {
		return m.ExpiredQueries
	}
	return nil
}
...
// QueryGetReporterLivenessRequest is the request type for the Query/GetReporterLiveness RPC method.
type QueryGetReporterLivenessRequest struct {
	// reporter defines the reporter address.
	Reporter string `protobuf:"bytes,1,opt,name=reporter,proto3" json:"reporter,omitempty"`
}

func (m *QueryGetReporterLivenessRequest) Reset()         { *m = QueryGetReporterLivenessRequest{} }
func (m *QueryGetReporterLivenessRequest) String() string { return proto.CompactTextString(m) }
func (*QueryGetReporterLivenessRequest) ProtoMessage()    {}
func (*QueryGetReporterLivenessRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb27caa9d264c5c4, []int{48}
}
func (m *QueryGetReporterLivenessRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetReporterLivenessRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetReporterLivenessRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetReporterLivenessRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetReporterLivenessRequest.Merge(m, src)
}
func (m *QueryGetReporterLivenessRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetReporterLivenessRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetReporterLivenessRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetReporterLivenessRequest proto.InternalMessageInfo

func (m *QueryGetReporterLivenessRequest) GetReporter() string {
	if m != nil {
		return m.Reporter
	}
	return ""
...
// QueryGetReporterLivenessResponse is the response type for the Query/GetReporterLiveness RPC method.
type QueryGetReporterLivenessResponse struct {
	// reporter_reports is the number of reports the reporter submitted
	ReporterReports uint64 `protobuf:"varint,1,opt,name=reporter_reports,json=reporterReports,proto3" json:"reporter_reports,omitempty"`
	// total_aggregates is the total number of aggregates on chain
	TotalAggregates uint64 `protobuf:"varint,2,opt,name=total_aggregates,json=totalAggregates,proto3" json:"total_aggregates,omitempty"`
	// percent_liveness is reports/aggregates * 100 (lifetime participation rate)
	PercentLiveness cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=percent_liveness,json=percentLiveness,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"percent_liveness"`
	// last_report_time is the timestamp of the reporter's last report
	LastReportTime int64 `protobuf:"varint,4,opt,name=last_report_time,json=lastReportTime,proto3" json:"last_report_time,omitempty"`
}

func (m *QueryGetReporterLivenessResponse) Reset()         { *m = QueryGetReporterLivenessResponse{} }
func (m *QueryGetReporterLivenessResponse) String() string { return proto.CompactTextString(m) }
func (*QueryGetReporterLivenessResponse) ProtoMessage()    {}
func (*QueryGetReporterLivenessResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb27caa9d264c5c4, []int{49}
}
func (m *QueryGetReporterLivenessResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetReporterLivenessResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetReporterLivenessResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetReporterLivenessResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetReporterLivenessResponse.Merge(m, src)
}
func (m *QueryGetReporterLivenessResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetReporterLivenessResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetReporterLivenessResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetReporterLivenessResponse proto.InternalMessageInfo

func (m *QueryGetReporterLivenessResponse) GetReporterReports() uint64 {
	if m != nil {
		return m.ReporterReports
	}
	return 0
}

func (m *QueryGetReporterLivenessResponse) GetTotalAggregates() uint64 {
	if m != nil {
		return m.TotalAggregates
	}
	return 0
}

func (m *QueryGetReporterLivenessResponse) GetLastReportTime() int64 {
	if m != nil {
...
// QueryGetCrossChainEscrowRequest is the request type for the Query/GetCrossChainEscrow RPC method.
type QueryGetCrossChainEscrowRequest struct {
	// EVM chain id of the escrow contract
	EscrowChainId uint64 `protobuf:"varint,1,opt,name=escrow_chain_id,json=escrowChainId,proto3" json:"escrow_chain_id,omitempty"`
	// hex-encoded 20-byte escrow contract address (no 0x prefix)
	EscrowContract string `protobuf:"bytes,2,opt,name=escrow_contract,json=escrowContract,proto3" json:"escrow_contract,omitempty"`
	// escrow id (nonce) inside the escrow contract
	EscrowId uint64 `protobuf:"varint,3,opt,name=escrow_id,json=escrowId,proto3" json:"escrow_id,omitempty"`
}

func (m *QueryGetCrossChainEscrowRequest) Reset()         { *m = QueryGetCrossChainEscrowRequest{} }
func (m *QueryGetCrossChainEscrowRequest) String() string { return proto.CompactTextString(m) }
func (*QueryGetCrossChainEscrowRequest) ProtoMessage()    {}
func (*QueryGetCrossChainEscrowRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb27caa9d264c5c4, []int{50}
}
func (m *QueryGetCrossChainEscrowRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetCrossChainEscrowRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetCrossChainEscrowRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetCrossChainEscrowRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetCrossChainEscrowRequest.Merge(m, src)
}
func (m *QueryGetCrossChainEscrowRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetCrossChainEscrowRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetCrossChainEscrowRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetCrossChainEscrowRequest proto.InternalMessageInfo

func (m *QueryGetCrossChainEscrowRequest) GetEscrowChainId() uint64 {
	if m != nil {
...
func (m *QueryGetCrossChainEscrowRequest) GetEscrowContract() string {
	if m != nil {
...
func (m *QueryGetCrossChainEscrowRequest) GetEscrowId() uint64 {
	if m != nil {
		return m.EscrowId
	}
	return 0
...
// QueryGetCrossChainEscrowResponse is the response type for the Query/GetCrossChainEscrow RPC method.
type QueryGetCrossChainEscrowResponse struct {
	// the escrow record
	Escrow CrossChainEscrow `protobuf:"bytes,1,opt,name=escrow,proto3" json:"escrow"`
	// hex settlement query id (fetch aggregate/snapshots under this id)
	SettlementQueryId string `protobuf:"bytes,2,opt,name=settlement_query_id,json=settlementQueryId,proto3" json:"settlement_query_id,omitempty"`
}

func (m *QueryGetCrossChainEscrowResponse) Reset()         { *m = QueryGetCrossChainEscrowResponse{} }
func (m *QueryGetCrossChainEscrowResponse) String() string { return proto.CompactTextString(m) }
func (*QueryGetCrossChainEscrowResponse) ProtoMessage()    {}
func (*QueryGetCrossChainEscrowResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb27caa9d264c5c4, []int{51}
}
func (m *QueryGetCrossChainEscrowResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetCrossChainEscrowResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetCrossChainEscrowResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetCrossChainEscrowResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetCrossChainEscrowResponse.Merge(m, src)
}
func (m *QueryGetCrossChainEscrowResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetCrossChainEscrowResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetCrossChainEscrowResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetCrossChainEscrowResponse proto.InternalMessageInfo

func (m *QueryGetCrossChainEscrowResponse) GetEscrow() CrossChainEscrow {
	if m != nil {
		return m.Escrow
	}
	return CrossChainEscrow{}
}

func (m *QueryGetCrossChainEscrowResponse) GetSettlementQueryId() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*QueryGetReporterLivenessRequest)(nil), "layer.oracle.QueryGetReporterLivenessRequest")
	proto.RegisterType((*QueryGetReporterLivenessResponse)(nil), "layer.oracle.QueryGetReporterLivenessResponse")
	proto.RegisterType((*QueryGetCrossChainEscrowRequest)(nil), "layer.oracle.QueryGetCrossChainEscrowRequest")
	proto.RegisterType((*QueryGetCrossChainEscrowResponse)(nil), "layer.oracle.QueryGetCrossChainEscrowResponse")
}
...
var fileDescriptor_bb27caa9d264c5c4 = []byte{
	...
	,
}
...
func (c *queryClient) GetReporterLiveness(ctx context.Context, in *QueryGetReporterLivenessRequest, opts ...grpc.CallOption) (*QueryGetReporterLivenessResponse, error) {
	out := new(QueryGetReporterLivenessResponse)
	err := c.cc.Invoke(ctx, "/layer.oracle.Query/GetReporterLiveness", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetCrossChainEscrow(ctx context.Context, in *QueryGetCrossChainEscrowRequest, opts ...grpc.CallOption) (*QueryGetCrossChainEscrowResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/layer.oracle.Query/GetCrossChainEscrow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) GetReporterLiveness(ctx context.Context, req *QueryGetReporterLivenessRequest) (*QueryGetReporterLivenessResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetReporterLiveness not implemented")
}
func (*UnimplementedQueryServer) GetCrossChainEscrow(ctx context.Context, req *QueryGetCrossChainEscrowRequest) (*QueryGetCrossChainEscrowResponse, error) {
...
func _Query_GetReporterLiveness_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryGetReporterLivenessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GetReporterLiveness(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/layer.oracle.Query/GetReporterLiveness",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GetReporterLiveness(ctx, req.(*QueryGetReporterLivenessRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Query_GetCrossChainEscrow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/layer.oracle.Query/GetCrossChainEscrow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryGetTippedQueriesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size := m.AvailableTipsTotal.Size()
		i -= size
		if _, err := m.AvailableTipsTotal.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintQuery(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x1a
	if len(m.ExpiredQueries) > 0 {
		for iNdEx := len(m.ExpiredQueries) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ExpiredQueries[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryGetReporterLivenessRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetReporterLivenessRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetReporterLivenessRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGetReporterLivenessResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetReporterLivenessResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetReporterLivenessResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.LastReportTime != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.LastReportTime))
		i--
		dAtA[i] = 0x20
	}
	{
		size := m.PercentLiveness.Size()
		i -= size
		if _, err := m.PercentLiveness.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintQuery(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x1a
	if m.TotalAggregates != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.TotalAggregates))
		i--
		dAtA[i] = 0x10
	}
	if m.ReporterReports != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.ReporterReports))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *QueryGetCrossChainEscrowRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetCrossChainEscrowRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetCrossChainEscrowRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.EscrowContract) > 0 {
		...
		i = encodeVarintQuery(dAtA, i, uint64(len(m.EscrowContract)))
		i--
		dAtA[i] = 0x12
	}
	if m.EscrowChainId != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.EscrowChainId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *QueryGetCrossChainEscrowResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetCrossChainEscrowResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetCrossChainEscrowResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.SettlementQueryId) > 0 {
		...
		i = encodeVarintQuery(dAtA, i, uint64(len(m.SettlementQueryId)))
		i--
		dAtA[i] = 0x12
	}
	{
...
func (m *QueryGetTippedQueriesResponse) Size() (n int) {
	...
	if len(m.ExpiredQueries) > 0 {
		for _, e := range m.ExpiredQueries {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
	l = m.AvailableTipsTotal.Size()
	n += 1 + l + sovQuery(uint64(l))
	if m.Pagination != nil {
		l = m.Pagination.Size()
		n += 1 + l + sovQuery(uint64(l))
...
func (m *QueryGetReporterLivenessRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetReporterLivenessResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ReporterReports != 0 {
		n += 1 + sovQuery(uint64(m.ReporterReports))
	}
	if m.TotalAggregates != 0 {
		n += 1 + sovQuery(uint64(m.TotalAggregates))
	}
	l = m.PercentLiveness.Size()
	n += 1 + l + sovQuery(uint64(l))
	if m.LastReportTime != 0 {
		n += 1 + sovQuery(uint64(m.LastReportTime))
	}
	return n
}

func (m *QueryGetCrossChainEscrowRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.EscrowChainId != 0 {
		n += 1 + sovQuery(uint64(m.EscrowChainId))
	}
...
func (m *QueryGetCrossChainEscrowResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetTippedQueriesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ActiveQueries = append(m.ActiveQueries, &QueryMetaButString{})
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExpiredQueries", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExpiredQueries = append(m.ExpiredQueries, &QueryMetaButString{})
			if err := m.ExpiredQueries[len(m.ExpiredQueries)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvailableTipsTotal", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.AvailableTipsTotal.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *QueryGetReporterLivenessRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetReporterLivenessRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetReporterLivenessRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryGetReporterLivenessResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetReporterLivenessResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetReporterLivenessResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReporterReports", wireType)
			}
			m.ReporterReports = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReporterReports |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalAggregates", wireType)
			}
			m.TotalAggregates = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalAggregates |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PercentLiveness", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.PercentLiveness.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastReportTime |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *QueryGetCrossChainEscrowRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetCrossChainEscrowRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetCrossChainEscrowRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			m.EscrowContract = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
...
func (m *QueryGetCrossChainEscrowResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetCrossChainEscrowResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetCrossChainEscrowResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
