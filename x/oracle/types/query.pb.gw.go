...
var (
	...
	pattern_Query_GetAggregatedReport_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"tellor-io", "layer", "oracle", "get_aggregated_report", "queryId", "blockNumber"}, "", runtime.AssumeColonVerbOpt(true)))
)
