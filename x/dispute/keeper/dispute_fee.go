...
func (k Keeper) PayFromBond(ctx sdk.Context, proposer sdk.AccAddress, fee sdk.Coin, hashId []byte, isFirstRound bool) error {
	return k.reporterKeeper.FeefromReporterStake(ctx, proposer, fee.Amount, hashId, isFirstRound)
}
