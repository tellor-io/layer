...
func BeginBlocker(ctx context.Context, k keeper.Keeper) error {
	...
	k.Logger(ctx).Info(fmt.Sprintf("Start time dispute module begin block: %d", time.Now().UnixMilli()))
...
func EndBlocker(ctx context.Context, k keeper.Keeper) error {
	...
	k.Logger(ctx).Info(fmt.Sprintf("Start time dispute module end block: %d", time.Now().UnixMilli()))
	...
	k.Logger(ctx).Info(fmt.Sprintf("End time dispute module end block: %d", time.Now().UnixMilli()))
	return nil
}
...
func CheckClosedDisputesForExecution(ctx context.Context, k keeper.Keeper) error {
	...
	k.Logger(ctx).Info(fmt.Sprintf("End time dispute module begin block: %d", time.Now().UnixMilli()))
	return nil
}
