...
var fileDescriptor_405fedac4fcc0287 = []byte{
	...
	0x56, 0xc8, 0x8a, 0x8b, 0x03, 0x64, 0x2d, 0xc8, 0x56, 0x09, 0x26, 0x05, 0x66, 0x0d, 0x6e, 0x23,
	0x09, 0x74, 0x7d, 0x2e, 0x89, 0x25, 0x89, 0xc1, 0x05, 0xa9, 0xc9, 0x50, 0x9d, 0x70, 0xf5, 0x4e,
	...
	0xaf, 0x0f, 0xf1, 0x4e, 0x05, 0xc2, 0x43, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0x60, 0x0f,
	0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xf3, 0x1b, 0x78, 0x75, 0x53, 0x01, 0x00, 0x00,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Dataspec) > 0 {
		for iNdEx := len(m.Dataspec) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Dataspec[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Dataspec = append(m.Dataspec, DataSpec{})
			if err := m.Dataspec[len(m.Dataspec)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
