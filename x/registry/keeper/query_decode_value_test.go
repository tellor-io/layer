...
func TestDecodeValueQuery(t *testing.T) {
	...
	res, err := querier.DecodeValue(ctx, &types.QueryDecodeValueRequest{QueryType: querytype, Value: "0x00000000000000000000000000000000000000000000090ea01c800d96350000"})
	require.NoError(t, err)
