...
// 	"github.com/tellor-io/layer/x/registry/simulation"
...
// 	registeredSpec := simulation.SimulateMsgRegisterSpec(s.accountKeeper, s.bankKeeper, s.registryKeeper, s.msgServer, t)
