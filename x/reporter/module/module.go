...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	...
	// if err := cfg.RegisterMigration(types.ModuleName, 1, m.MigrateFork); err != nil {
	// 	panic(err)
	// }
}

// RegisterInvariants registers the invariants of the module. If an invariant deviates from its predicted value, the InvariantRegistry triggers appropriate logic (most often the chain will be halted)
// TODO: RegisterInvariants is deprecated in SDK v0.53.4 and will be removed in future versions
func (am AppModule) RegisterInvariants(_ sdk.InvariantRegistry) {} //nolint:staticcheck // removing crisis module will break interchaintests
