...
func TestGenesis(t *testing.T) {
	...
	require.Equal(t, genesisState.Reporters, got.Reporters)
	require.Equal(t, genesisState.SelectorTips, got.SelectorTips)
	require.Equal(t, genesisState.Selectors, got.Selectors)
	require.Equal(t, genesisState.DisputedDelegationAmounts, got.DisputedDelegationAmounts)
	require.Equal(t, genesisState.FeePaidFromStake, got.FeePaidFromStake)
	require.Equal(t, genesisState.Report, got.Report)
