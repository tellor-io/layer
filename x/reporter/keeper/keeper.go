...
type (
	Keeper struct {
		...
		SelectorTips              collections.Map[[]byte, uint64]
...
func NewKeeper(
	...
	k := Keeper{
		...
		SelectorTips:              collections.NewMap(sb, types.SelectorTipsPrefix, "delegator_tips", collections.BytesKey, collections.Uint64Value),
